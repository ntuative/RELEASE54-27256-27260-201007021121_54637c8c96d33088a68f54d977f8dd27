package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_761:OffenceCategoryData;
      
      private var var_441:ITextFieldWindow;
      
      private var var_924:IButtonWindow;
      ...
      private var var_922:IDropMenuWindow;
      
      private var var_53:IFrameWindow;
      
      private var var_760:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_923 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_924 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_922.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1363,var_441.text,getBanLength(),var_1364));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_922.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1363,var_441.text,var_1364));
         this.dispose();
      }
      ...
      {
         return WindowTracker.const_1306;
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_761 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1363,var_441.text,var_1364));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_761 != null;
         if(this.var_760 != null)
         {
            var_53.findChildByName("offence_txt").caption = this.var_760.name;
            var_53.findChildByName("offence_category").visible = true;
         }
         else if(this.var_761 != null)
         {
            this.refreshButtons("offences_cont",2,var_761.offences,var_923,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_924,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_760 = var_761.offences[_loc3_];
         var_441.text = var_760.msg;
         var_311 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_53.caption = "Mod action on: " + var_1614;
         ...
         var_922 = IDropMenuWindow(var_53.findChildByName("banLengthSelect"));
         prepareBanSelect(var_922);
