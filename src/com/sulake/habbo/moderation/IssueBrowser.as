package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1522:IIssueBrowserView;
      
      private const const_1738:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1737:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1521:IIssueBrowserView;
      
      private const const_1759:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1736:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_231:ITabContextWindow;
      
      private var var_1523:PickedIssuesView;
      
      private var var_360:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_231 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_231.numTabItems)
            {
               _loc5_ = var_231.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_231.selector.getSelectableByName("open_issues");
         var_231.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_360.view.width = var_231.container.width;
         var_360.view.height = var_231.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1736:
               if(var_1521 == null)
               {
                  var_1521 = new MyIssuesView(issueManager,this,var_231.container);
               }
               return var_1521;
            case const_1738:
               if(var_1522 == null)
               {
                  var_1522 = new OpenIssuesView(issueManager,this,var_231.container);
               }
               return var_1522;
            case const_1737:
               if(var_1523 == null)
               {
                  var_1523 = new PickedIssuesView(issueManager,this,var_231.container);
               }
               return var_1523;
            default:
               return null;
