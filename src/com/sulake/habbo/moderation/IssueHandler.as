package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_446:UserInfoCtrl;
      
      private var var_63:ModerationManager;
      
      private var var_1125:UserInfoCtrl;
      
      private var var_120:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.releaseBundle(var_120.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_120.getHighestPriorityIssue();
         var_446 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_1125 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_446.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1125.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_120.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_120.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_120.getHighestPriorityIssue().issueId;
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_1015,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_63 != null && false && var_120 != null)
         {
            var_63.issueManager.removeHandler(var_120.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_120.getHighestPriorityIssue();
            var_446 = new UserInfoCtrl(_window,var_63,_loc3_.message);
            var_446.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_120.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_120.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1403;
      }
   }
}
