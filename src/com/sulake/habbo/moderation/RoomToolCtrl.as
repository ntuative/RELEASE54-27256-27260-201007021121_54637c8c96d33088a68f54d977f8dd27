package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_707:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_537,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_471);
         if(param1.flatId != var_471)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_471);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_707.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1413,_loc2_,var_441.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1040.isSelected,var_1041.isSelected,var_707.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1268);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1223);
      }
      
      public function populate() : void
      {
         var_52 = IItemListWindow(var_53.findChildByName("list_cont"));
         ...
         var_707 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1040 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1041 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_471));
         Logger.log("BEGINNING TO SHOW: " + var_471);
      }
   }
}
