package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2143:IWindowContainer;
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(var_52.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = var_52.scrollableRegion.height > var_52.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2143.clone());
      ...
      {
         var_2143 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_52 = IItemListWindow(var_53.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1317;
      }
   }
}
