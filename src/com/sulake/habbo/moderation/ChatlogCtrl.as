package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1540:IMessageComposer;
      ...
      private var var_962:IWindowContainer;
      ...
      {
         var_962 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_963 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         var_461 = new Timer(300,1);
         var_461.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_53 = IFrameWindow(_main.getXmlWindow("chatlog_frame"));
         var_52 = IItemListWindow(var_53.findChildByName("chatline_list"));
         var_53.procedure = onWindow;
         var _loc1_:IWindow = var_53.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1540);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_962.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_53,_main,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
         ...
         var_52.addListItem(_loc2_);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            populateChatline(var_52,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         if(param1.type != WindowEvent.const_42 || param2 != var_53)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_963.clone());
         _loc4_.color = var_1419[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         var _loc5_:ITextWindow = ITextWindow(_loc4_.findChildByName("time_txt"));
         _loc5_.text = RoomVisitsCtrl.getFormattedTime(param2.hour,param2.method_10);
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_53,_main,_loc6_,param2.chatterId);
         }
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(var_52.getListItemAt(_loc1_));
