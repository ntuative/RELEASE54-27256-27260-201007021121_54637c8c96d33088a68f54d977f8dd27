package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1317:int = 6;
      
      public static const const_537:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1306:int = 7;
      
      public static const const_1015:int = 3;
      
      public static const const_1403:int = 8;
      
      public static const const_851:int = 5;
      
      public static const const_1280:int = 1;
      
      public static const const_1337:int = 2;
      ...
      {
         var_1530 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1530[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1530[param1] = _loc2_;
         }
         return _loc2_;
      }
