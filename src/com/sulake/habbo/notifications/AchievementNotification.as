package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1859 = param2;
         var_357 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_113,onBadgeImageReady);
         ...
         var_2374 = param5.getKey("notifications.text.achievement_facebook");
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_827,var_2374);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_827,var_827));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_827,var_827));
         _localizations.registerParameter(param1,"level",var_1859.toString());
         _localizations.registerParameter(param1,"name",var_357.userName);
         _localizations.registerParameter(param1,"realname",var_357.realName);
      }
   }
}
