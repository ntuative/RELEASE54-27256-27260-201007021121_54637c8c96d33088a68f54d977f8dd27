package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1083:String = "badges";
      
      private static const const_1080:String = "pet_inventory";
      
      private static const const_1084:String = "pixelbalance";
      
      private static const const_1078:String = "credits";
      
      private static const const_1079:String = "inventory";
      
      private static const const_1085:String = "friendlist";
      
      private static const const_1082:String = "selectfurni";
      
      private static const const_1081:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_602:ParkBusDialogManager;
      
      private var var_601:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_405:HabboNotificationViewManager;
      
      private var var_709:ClubEndingNotification;
      ...
      private var var_199:HabboAlertDialogManager;
      
      private var var_710:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_854);
         }
         var _loc6_:Map = var_854["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1425);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_710 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_199 == null)
         {
            return;
         }
         var_199.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_929)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1363);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_199.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_199.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_601)
         {
            var_601.release(new IIDHabboToolbar());
            var_601 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_80:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1209);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1769)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1004);
            var_1769 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1080:
               if(var_14)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_144);
               }
               break;
            case const_1082:
               break;
      ...
      {
         if(param1 != null && this.var_405 != null)
         {
            var_405.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1004,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_440.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_30,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_41);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1037,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_171 || param2.type == WindowEvent.const_701)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_405.isSpaceAvailable() && false)
         {
            var_405.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_602 == null)
         {
            var_602 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_602 != null)
         {
            var_602.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1045.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_440.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc9_ = var_357.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_78)
               {
                  _loc9_ = var_357.getWallItemData(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1318,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_440.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1045.push(_loc8_);
         return var_1045.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1431)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_709 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_199 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_601 = IHabboToolbar(param2);
         var_601.events.addEventListener(HabboToolbarEvent.const_86,onHabboToolbarEvent);
      }
      
      private function method_6(param1:IMessageEvent) : void
      {
         ...
         var_199.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_357.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_872);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_872);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_199.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_312;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_309;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_86)
         {
            ...
            var_405 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_854["styles"],var_854["view"],var_601);
            ...
            _communication.addHabboConnectionMessageEvent(new InfoHotelClosingMessageEvent(method_6));
            ...
            registerUpdateReceiver(var_405,1);
            registerUpdateReceiver(this,2);
            var_357.events.addEventListener(BadgeImageReadyEvent.const_113,onBadgeImage);
            var_601.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
