package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_495,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_441,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_495,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_441,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_60:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_495:
               if(!var_256)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_441:
               if(!var_256)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_693,var_167);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1072,const_1073,2,2),null,0) as IWindowContainer;
