package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_60,onObjectUpdate);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_81,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_112,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_60,onPresentUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_60:
               ...
               showInterface();
               break;
            case RoomWidgetEcotronBoxDataUpdateEvent.const_81:
               if(!var_256)
               {
                  return;
               }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_60,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_81,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_60,onPresentUpdate);
      ...
      {
         var _loc1_:* = null;
         if(var_256 || var_167 == -1 || !_controller)
         {
            return;
         }
         var_256 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_584,var_167);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1072,const_1073,2,2),null,0) as IWindowContainer;
