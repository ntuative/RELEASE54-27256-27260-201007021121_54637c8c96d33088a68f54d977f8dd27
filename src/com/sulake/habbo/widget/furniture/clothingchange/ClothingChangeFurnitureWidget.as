package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_807:String = "Girl";
      
      private static const const_806:String = "Boy";
      ...
      private var var_659:IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_311,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_976,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_343,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_311:
               showGenderSelectionInterface(param1);
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_343:
               hideEditorInterface();
         }
      }
      ...
      {
         requestEditor(FigureData.const_69);
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1791 = param1.objectCategory;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_311,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_976,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_343,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_98,true);
         var_659 = _loc4_;
         var_659.offset(100,100);
         var _loc6_:IWindow = var_659.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_331,param1,var_167,var_1791,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_659 != null)
         {
            _loc1_ = var_659 as IFrameWindow;
            if(_loc1_ != null)
            {
