package com.sulake.habbo.widget.furniture.placeholder
{
   ...
   public class PlaceholderView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("habbohelp_window","",HabboWindowType.const_52,HabboWindowStyle.const_34,0 | 0,new Rectangle(-300,300,10,10),null) as IWindowContainer;
