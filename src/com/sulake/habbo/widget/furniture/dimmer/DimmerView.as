package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1072:Number = 100;
      
      private static const const_1073:Number = 100;
       
      
      private var var_1457:XML;
      
      private var var_409:int;
      
      private var var_574:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2326:int;
      
      private var var_390:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_231.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_231.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1072,const_1073,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_574 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_390 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_231 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_231.numTabItems)
         {
            _loc6_ = var_231.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_37,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_574 != null)
         {
            var_574.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_231.selector.getSelected();
         return var_231.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_390 != null)
         {
            var_390.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1173 = _loc2_.light;
         if(var_390 != null)
         {
            var_390.setValue(var_1173);
         }
         var_409 = colors.indexOf(_loc2_.color);
         if(var_574 != null)
         {
            var_574.setSelectedColorIndex(var_409);
         }
