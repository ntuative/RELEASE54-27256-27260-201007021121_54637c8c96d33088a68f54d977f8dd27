package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_95 && param1.type != WindowMouseEvent.const_373)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1570 * (var_1077 - var_739)) + var_739;
      }
   }
}
