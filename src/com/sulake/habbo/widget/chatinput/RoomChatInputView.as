package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1495:int = 5;
      
      private static const const_517:int = 16;
      
      private static const const_1168:int = 20;
      
      private static const const_366:int = 10;
      
      private static const const_1169:int = 40;
      ...
      private var var_417:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1168 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2299 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2301 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_813 = new Timer(1000,1);
         var_813.addEventListener(TimerEvent.TIMER_COMPLETE,method_7);
         var_994 = new Timer(5000,1);
         var_994.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_52,HabboWindowStyle.const_34,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_42,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_131,onInputChanged);
         _window.addEventListener(WindowEvent.const_393,onWindowMoved);
         var_1452 = true;
         var_148 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2300 = _loc2_.width + const_517 + _loc6_.width + const_1168;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1169,_loc8_.width) + const_517);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1168 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_148 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_417);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_417);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_48,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_569);
