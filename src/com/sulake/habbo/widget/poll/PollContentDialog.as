package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_784[var_1140] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_325)
         {
            ...
            var_325 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_325.center();
            var_325.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1140;
         if(var_1140 < var_784.length)
         {
            _loc1_ = var_784[var_1140] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_784.length);
                  _loc2_.text = _loc6_;
               }
