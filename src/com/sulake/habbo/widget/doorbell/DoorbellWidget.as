package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1180:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_594,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_128,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_51,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_594,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_128,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_51,onDoorbellHandled);
      }
