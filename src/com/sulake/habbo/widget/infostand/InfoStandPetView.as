package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1753:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1747:String = "level";
      
      private var var_108:IItemListWindow;
      
      private const const_1752:String = "energy";
      
      private var var_1235:Map;
      
      private const const_1749:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1755:uint = 3355443;
      
      private var var_235:IBorderWindow;
      
      private const const_1751:int = 158;
      
      private const const_1754:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_186:PetCommandTool;
      
      private const const_1748:uint = 11184810;
      
      private const const_1750:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_235 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_235 != null)
         {
            var_108 = var_235.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_235.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_235.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         for each(_loc8_ in _loc7_)
         {
            ...
            _loc8_.addEventListener(WindowEvent.const_42,onButtonResized);
         }
      }
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_108.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_108.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_108 == null || var_235 == null || var_65 == null)
         {
            return;
         }
         ...
         var_235.height = NaN;
         _window.width = Math.max(var_235.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_186 == null)
         {
            var_186 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1235.getValue(var_680) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_186.showWindow(true);
            var_186.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_108.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_108.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1747,param1.level,param1.levelMax);
         updateStateElement(const_1750,param1.experience,param1.experienceMax);
         updateStateElement(const_1752,param1.energy,param1.energyMax);
         updateStateElement(const_1749,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_680 = param1.id;
         var_1235.remove(param1.id);
         var_1235.add(param1.id,param1);
         if(var_186 && var_186.isVisible() && param1.isOwnPet)
         {
            var_186.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_108.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_186.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_186 && var_186.getPetId() == var_680)
               {
                  var_186.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_502,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1751,const_1754,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1748);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1755);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1753);
         return _loc5_;
      }
