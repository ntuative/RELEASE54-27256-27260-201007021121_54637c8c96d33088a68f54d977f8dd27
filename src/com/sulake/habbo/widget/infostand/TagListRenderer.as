package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1730:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1422 != null && var_1422.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_122);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_844 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_844 += param1.height + const_1730;
            return fit(param1);
         }
         param1.offset(_offsetX,var_844);
         _offsetX += param1.width + const_1729;
         return true;
      }
