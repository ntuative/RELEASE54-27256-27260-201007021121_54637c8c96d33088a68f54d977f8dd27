package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_391:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_1073:Map;
      
      private const const_1758:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1073 = new Map();
         var_392 = new Timer(const_1758);
         var_392.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function createCommandWindow() : void
      {
         ...
         var_44.setParamFlag(WindowParam.const_85,true);
         var_44.context.getDesktopWindow().addEventListener(WindowEvent.const_42,onWindowDesktopResized);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_562,param1);
      ...
      {
         var_1073.remove(param1);
         var_1073.add(param1,param2);
         if(param1 != var_680)
         {
            return;
         }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_391 == null)
         {
            ...
            var_391 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_391 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_391.x = 200;
            var_391.procedure = onInfoWindowProcedure;
         }
         else
         {
            var_391.visible = true;
         }
      }
      
      private function onButtonDisableTimeout(param1:TimerEvent) : void
      {
         var _loc2_:Array = var_1073.getValue(var_680) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_501,var_680));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_738,var_680,var_2341 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1073.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_680);
         }
         else
         {
