package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_517:int = 6;
      
      private static const const_366:int = 10;
      
      private static const const_1110:Number = 18;
      
      private static const const_1476:Number = 10;
      
      private static const const_1475:Number = 8;
       
      
      private var var_1342:Number;
      ...
      {
         _widget.onItemMouseOut(var_1096,var_1097,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1096,var_750,var_1097,_roomId,_roomCategory,param1);
      }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_48,onBubbleMouseDown);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1343)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_106:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_291:
         ...
         if(var_207 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_433 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1098 != 0)
            {
               _loc30_ = uint(var_1098 >> 16 & 255);
               _loc31_ = uint(var_1098 >> 8 & 255);
               _loc32_ = uint(var_1098 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_366;
            }
            else
            {
               _loc19_.text = var_750 + ":";
               _loc19_.y += var_433;
               _loc19_.width = _loc19_.textWidth + const_366;
               _width += _loc19_.textWidth + const_366;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1343 == RoomWidgetChatUpdateEvent.const_291)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_750);
            }
            else if(var_1343 == RoomWidgetChatUpdateEvent.const_285)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_750);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_433;
            _loc20_.width = _loc20_.textWidth + const_517;
            _width += _loc20_.textWidth + const_517;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_366 + _loc20_.textWidth + const_517;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1096,var_1097,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1096,var_1097,_roomId,_roomCategory,param1);
      }
