package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_801:int = 3;
      
      private static const const_827:int = 150;
      
      private static const const_826:int = 250;
      ...
      private var var_1686:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_40 = param3;
         var_2297 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1688 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2296 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1686 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1687 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2294 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2295 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_76 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_76),null,0,0) as IBitmapWrapperWindow;
         var_40.addChild(var_76);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_52,HabboWindowStyle.const_36,HabboWindowParam.const_37,new Rectangle(0,0 - const_76,param3.width,const_76),null,0) as IWindowContainer;
         var_40.addChild(_window);
         var_104 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_382,HabboWindowStyle.const_34,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_76),null,0) as IRegionWindow;
         if(var_104 != null)
         {
            var_104.background = true;
            var_104.mouseTreshold = 0;
            var_104.addEventListener(WindowMouseEvent.const_48,onPulldownMouseDown);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_376:
               var_76.blend += param1 / const_826;
               _window.blend += param1 / const_826;
               if(false)
               {
                  state = const_355;
               }
               break;
            case const_801:
               var_76.blend = 0 - param1 / const_827;
               _window.blend = 0 - param1 / const_827;
               if(true)
               {
                  state = const_220;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_104.x = 0;
            var_104.y = 0 - const_76;
            var_104.width = 0 - var_2298;
         }
         if(var_76 != null)
         {
            var_76.rectangle = var_40.rectangle;
            var_76.height = 0 - const_76;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2293 == _window.width)
         {
            return;
         }
         var_2293 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2297.clone(),_loc7_);
