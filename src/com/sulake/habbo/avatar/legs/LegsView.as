   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_244,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_219,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_152 == "")
         {
            _model.switchCategory(FigureData.TROUSERS);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_pants":
                  switchCategory(FigureData.TROUSERS);
                  break;
               case "tab_shoes":
                  switchCategory(FigureData.const_244);
                  break;
               case "tab_belts":
                  switchCategory(FigureData.const_219);
            }
         }
