   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_227,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_165,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_212,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_152 == "")
         {
            _model.switchCategory(FigureData.const_165);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  switchCategory(FigureData.const_227);
                  break;
               case "tab_shirt":
                  switchCategory(FigureData.const_165);
                  break;
               case "tab_accessories":
                  switchCategory(FigureData.CHEST_ACCESSORIES);
                  break;
               case "tab_prints":
                  switchCategory(FigureData.const_212);
            }
         }
