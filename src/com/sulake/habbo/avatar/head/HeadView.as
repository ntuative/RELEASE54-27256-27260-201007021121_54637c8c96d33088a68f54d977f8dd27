   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FigureData.const_203:
               var_45 = "tab_hat";
               break;
            case FigureData.const_245:
               var_45 = "tab_accessories";
               break;
            case FigureData.const_215:
               var_45 = "tab_eyewear";
               break;
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_166,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_203,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_245,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_215,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_204,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_152 == "")
         {
            _model.switchCategory(FigureData.const_166);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  switchCategory(FigureData.const_245);
                  break;
               case "tab_eyewear":
                  switchCategory(FigureData.const_215);
                  break;
               case "tab_masks":
                  switchCategory(FigureData.const_204);
            }
         }
