package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_531:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_530:IFrameWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2047:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1101 = [];
         var_1180 = [AvatarEditorFigureCategory.const_760,AvatarEditorFigureCategory.const_41,AvatarEditorFigureCategory.const_226,AvatarEditorFigureCategory.const_600,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_94];
         super();
         _controller = param1;
         ...
         var_372 = new Timer(1000);
         var_372.addEventListener(TimerEvent.TIMER,onUpdate);
         if(param4 == null)
         {
            param4 = var_1180;
         }
      ...
      public function update() : void
      {
         ...
         if(_controller.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1597 == AvatarEditorSideCategory.const_94 || var_2047))
         {
      ...
      public function dispose() : void
      {
         ...
         {
            var_372.stop();
            var_372.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_372 = null;
         }
         if(_window != null)
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_530)
         {
            ...
            var_530 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_530.procedure = stripClubDialogEventProc;
            var_530.center();
         }
         else
         {
            var_530.visible = true;
            var_530.center();
         }
      }
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_531 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_531.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1101.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_531.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_531.numSelectables)
               {
                  var_531.getSelectableAt(_loc6_).x = var_531.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1180);
         }
         if(param1.length != var_1101.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1101.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function method_1(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_541:
               break;
            case AvatarEditorSideCategory.const_420:
               _loc3_ = _controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_420);
               break;
      ...
      {
         if(var_1597 == AvatarEditorSideCategory.const_94)
         {
            var_2047 = false;
            method_1(AvatarEditorSideCategory.const_541);
         }
         else
         {
            method_1(AvatarEditorSideCategory.const_94);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_276 = param1;
         var_531.setSelected(var_531.getSelectableByName(param1));
         _window.invalidate();
      }
