package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1486:int = 60000;
      ...
      private var var_1011:IAvatarImage;
      ...
      private function updateBodyPartCache(param1:String, param2:AvatarImageBodyPartCache) : void
      {
         ...
         var_144.add(param1,param2);
      }
      
      public function setGeometryType(param1:String) : void
      {
         if(var_669 == param1 || var_669 == GeometryType.const_907 && param1 == GeometryType.const_989 || param1 == GeometryType.const_907 && var_669 == GeometryType.const_989)
         {
            var_669 = param1;
            return;
         }
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_82.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_144.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_144.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_82.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_736)
                  {
                     if(_loc18_.action != null)
                     {
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_82.getParts(param1,var_1011.getFigure(),_loc6_,var_669,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_154,var_669);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1207[param1])
            {
            ...
            _loc9_ = var_154 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_154 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               {
                  _loc33_ = var_82.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc30_ == AvatarAction.const_1027 || _loc30_ == AvatarAction.const_381) && (_loc6_ == AvatarBodyPartType.const_226 || _loc6_ == AvatarBodyPartType.const_1335 || _loc6_ == AvatarBodyPartType.const_1343) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_154 == AvatarScaleType.const_49)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_82.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_144 != null)
         {
            _loc2_ = var_144.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_144.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_82.getBodyPartsUnordered(param1);
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_144 != null)
         {
            ...
            {
               _loc5_ = var_144.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
