package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1125:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_920:AvatarEditorHandler;
      ...
      private const const_1124:int = 2;
      ...
      private var var_1114:IHabboAvatarEditorDataSaver = null;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_757.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_170)
         {
            ...
            var_546["null"] = new FigureData(this);
            var_546["null"] = new FigureData(this);
            _loc1_ = var_546["null"];
            _loc2_ = var_546["null"];
            _loc1_.loadAvatarData(const_1123,FigureData.const_69);
            _loc2_.loadAvatarData(const_1125,FigureData.FEMALE);
            var_95 = new Map();
            var_439 = new Map();
            var_95.add(AvatarEditorFigureCategory.const_760,new BodyModel(this));
            var_95.add(AvatarEditorFigureCategory.const_41,new HeadModel(this));
            var_95.add(AvatarEditorFigureCategory.const_226,new TorsoModel(this));
            var_95.add(AvatarEditorFigureCategory.const_600,new LegsModel(this));
            var_95.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_439.add(AvatarEditorSideCategory.const_94,new WardrobeModel(this));
            var_439.add(AvatarEditorSideCategory.const_420,new ClubPromoModel(this));
            var_170 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1114 != null)
         {
            ...
            _loc2_ = "null";
            var_1114.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1115 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = isClubTryoutAllowed() && var_1609;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || var_1115 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_1124)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = var_440.getMandatoryAvatarPartSetIds(gender,_loc20_);
            }
            else
            {
               _loc14_ = var_440.getMandatoryAvatarPartSetIds(gender,clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1194)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || var_1115 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_439.getValue(AvatarEditorSideCategory.const_94);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_920 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_757.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_439.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_245 == null)
            {
               var_245 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_245.addChild(_view.window);
               var_245.center();
               var_245.visible = false;
            }
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_760);
         }
         var_1114 = param2;
         return true;
      }
      ...
      {
         var_757 = var_440.getFigureData(AvatarType.const_68);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_440 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1115 = param3;
         var _loc4_:FigureData = var_546[param2];
         if(_loc4_ == null)
         {
            return;
         }
