package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class OutfitView
   {
      ...
      public function OutfitView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:Boolean)
      {
         ...
         if(_window != null)
         {
            var_386 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
         if(!param3)
         {
      ...
      {
         var_386.bitmap = new BitmapData(var_386.width,var_386.height,true,16777215);
         var _loc2_:int = (0 - param1.width) / 2;
         var _loc3_:int = 0 - param1.height;
         var_386.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
