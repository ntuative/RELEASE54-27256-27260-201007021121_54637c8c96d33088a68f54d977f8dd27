package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_459:PartSetsData;
      
      private var var_1673:PartOffsetData;
      
      private var var_977:AvatarActionManager;
      
      private var var_190:IAssetLibrary;
      
      private var var_978:IAssetLibrary;
      
      private var var_411:AvatarRenderManager;
      
      private var var_335:FigureData;
      
      private var var_638:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_670:String;
      
      private var var_1672:AvatarStructureDownloadSet;
      
      private var var_801:Dictionary;
      
      private var var_800:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_190 = param2;
         var_978 = param3;
         var_335 = new FigureData();
         var_459 = new PartSetsData();
         var_638 = new AnimationData();
         var_1672 = new AvatarStructureDownloadSet();
         var_800 = new AnimationManager();
         var_670 = param4;
         var_1673 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_977.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_670)
         {
            case AvatarType.const_68:
               _loc1_ = var_190.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_459.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_190.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_638.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_190.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_335.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_190.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_459.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_190.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_638.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_190.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_335.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_977.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_335.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_977.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_800.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  {
                     _loc5_ = _geometry.getBodyPart(_loc4_,_loc12_.align);
                     if(_loc5_ != null)
                     {
                        _loc10_.@id = _loc12_.id;
                        _loc5_.addPart(_loc10_);
                        _loc11_["set-type"] = _loc12_.id;
                        _loc9_ = var_459.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_459.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1404[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_977.getDefaultAction();
         var _loc9_:Array = var_459.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_800.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               for each(_loc20_ in _loc10_.getAnimatedBodyPartIds(0))
               {
                  if(_loc20_ == param1)
                  {
                     _loc21_ = _geometry.getBodyPart(param4,_loc20_);
                     if(_loc21_ != null)
                     {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_335.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_335.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_638.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_459.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_459.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_670 + " ready to go!");
         if(var_670 == AvatarType.const_68)
         {
            var_459.getPartDefinition("ri").appendToFigure = true;
            var_459.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_68:
               if(var_190.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_190.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_190.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_190.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_68:
               if(var_190.hasAsset(_loc5_))
               {
                  var_190.removeAsset(var_190.getAssetByName(_loc5_));
               }
               var_1672.add(new AvatarStructureDownload(var_190,_loc5_,var_335));
               break;
            case AvatarType.PET:
         }
         var_1672.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_800.getAnimation(param1);
      }
      ...
      {
         var_977 = new AvatarActionManager(var_190,var_670);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_801[param1] = new Dictionary();
         }
         if(var_801[param1][param2])
         {
            return var_801[param1][param2];
         }
         var_801[param1][param2] = var_335.getMandatorySetTypeIds(param1,param2);
         return var_801[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_335.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_978.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_978.getAssetByName("dance" + _loc1_).content as XML;
            var_800.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_978.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_978.getAssetByName("fx" + _loc1_).content as XML;
            var_800.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_335.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_335.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1673.loadOffsets(var_978);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_977.sortActions(param1);
      }
   }
}
