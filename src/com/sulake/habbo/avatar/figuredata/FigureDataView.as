package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1163:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1163 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_386 && var_1163)
         {
            ...
            var_386.bitmap.copyPixels(var_1163,var_1163.rect,new Point(0,0 - 0 - 8));
            var_386.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
