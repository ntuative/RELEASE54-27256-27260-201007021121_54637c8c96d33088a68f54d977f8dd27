package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1113:Map;
      
      private var var_1535:Number = 1.0;
      
      private var _b:uint;
      
      private var var_1538:Number = 1.0;
      
      private var var_1607:int;
      
      private var _colorTransform:ColorTransform;
      
      private var var_2091:uint;
      
      private var var_1534:uint;
      
      private var var_1537:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1537,var_1538,var_1535,_alphaMultiplier);
         var_1113 = generatePaletteMapForGrayscale(var_2091,var_2090);
      }
      
      public function get reds() : Array
      {
         return var_1113.getValue("reds") as Array;
      }
      ...
      {
         return var_1113.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1113.getValue("greens") as Array;
      }
      ...
      {
         return var_1113.getValue("alphas") as Array;
      }
