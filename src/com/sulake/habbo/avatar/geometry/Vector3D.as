package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_92 * param1.y;
         _loc2_.y = var_92 * param1.x - var_91 * param1.z;
      ...
      {
         return Math.sqrt(var_91 * var_91 + _y * _y + var_92 * var_92);
      }
      ...
      {
         return var_91 * param1.x + _y * param1.y + var_92 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_91 + "," + _y + "," + var_92 + "," + var_1126 + ")";
      }
