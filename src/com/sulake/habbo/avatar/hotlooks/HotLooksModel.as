package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1673:String = "hot_looks";
      
      public static const const_1620:String = "my_looks";
      ...
      {
         super(param1);
         var_412 = new Dictionary();
         var_412["null"] = new Array();
         var_412["null"] = new Array();
         var_412["undefined.index"] = 0;
         var_412["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_412[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
