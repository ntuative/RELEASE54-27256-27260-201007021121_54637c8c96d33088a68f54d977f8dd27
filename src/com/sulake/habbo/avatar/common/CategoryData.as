package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1761:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_790 >= 0 && var_188.length > var_790)
         {
            _loc2_ = var_188[var_790];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_188.length > param1)
         {
            _loc3_ = var_188[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_214.length)
         {
            ...
            {
               if(_loc7_.length > var_214[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_214[param2],param2);
         var_214[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_214[param1])
         {
            return null;
         }
      ...
      {
         return var_188[var_790] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_214 = new Array(param1.length);
         var _loc3_:int = 0;
