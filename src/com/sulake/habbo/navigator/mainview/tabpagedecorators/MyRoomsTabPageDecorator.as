package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_567:IDropMenuWindow;
      
      private var var_2540:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_659;
         }
         if(param1 == 2)
         {
            return Tabs.const_658;
         }
         if(param1 == 3)
         {
            return Tabs.const_529;
         }
         if(param1 == 4)
         {
            return Tabs.const_747;
         }
         return Tabs.const_239;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_567 == null ? 0 : int(var_567.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_290,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_567 == null)
         {
            var_567 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_567.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
