package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1174:int = 267;
      
      private static const const_1173:int = 65;
      
      private static const const_1172:int = -70;
       
      
      private var var_2361:PublicRoomThumbs;
      ...
      {
         var _loc4_:String = var_2361.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1172) : 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1439)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1173) : int(const_1174);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_528 || param2.type == OfficialRoomEntryData.const_595))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_894.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_328,_loc2_.tag);
         }
