package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1155:int = -16;
      
      private static const const_812:int = 32;
      
      private static const const_1153:int = 8;
      
      public static const const_412:int = 10;
      
      private static const const_1154:int = 40;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_1166:Dictionary;
      
      private var var_2272:Dictionary;
      
      private var var_984:ThumbnailImageConfigurations;
      
      private var var_1445:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_1166 = new Dictionary();
         super();
         _navigator = param1;
         var_984 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_34,0 | (!!param3 ? HabboWindowParam.const_37 : HabboWindowParam.const_34),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_984.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1155,_loc4_.y + const_1154 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2272[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_984.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_984.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_984.getImage(ThumbnailEditorModel.const_50,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_812 / 2);
         return new Point(param1 * const_812 + _loc3_,param2 * const_1153);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_412)
         {
            var_1166[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1166[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_412)
         {
            if(false)
            {
               refreshObj(param1,var_1166[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1445 == null)
         {
            var_1445 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1445,var_1445.rect,new Point(0,0),null,null,true);
      }
   }
}
