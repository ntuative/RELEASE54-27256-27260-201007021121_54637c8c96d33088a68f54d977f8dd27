package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_383 = new Timer(500,1);
         var_329 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1274 = param4;
         var_2241 = param2;
         _popupIndentLeft = param3;
         var_383.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_383)
         {
            var_383.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_383.reset();
            var_383 = null;
         }
         if(var_329)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_51 == null)
         {
            var_51 = IWindowContainer(_navigator.getXmlWindow(var_1274));
            var_51.visible = false;
         ...
         var_51.x = _loc2_.x + var_2241 + param1.width;
