package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_867:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_506 = new Timer(100);
         var_506.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_41 = new Array();
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,104,"a"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,94,"b"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,36,"c"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,84,"d"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,80,"e"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,80,"f"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,416,"i"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,320,"j"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,448,"k"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,352,"l"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,384,"m"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_45,372,"n"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"g"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,74,"h"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"o"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"p"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,304,"q"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,336,"r"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,748,"u"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,438,"v"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,540,"t"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,512,"w"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,396,"x"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,440,"y"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,456,"z"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_47,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_52 = IItemListWindow(var_22.findChildByName("item_list"));
         ...
         var_1059 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_506)
         {
            var_506.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_506.reset();
            var_506 = null;
         }
      }
      ...
      {
         var_1059.goBackToInitialState();
         var_1059.input.textBackgroundColor = 4294967295;
         var_867 = var_41[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_52,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1059.getText();
      ...
      {
         var _loc1_:Boolean = var_1059.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_867.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1269 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1269 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc6_ = var_52.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in var_41)
         {
