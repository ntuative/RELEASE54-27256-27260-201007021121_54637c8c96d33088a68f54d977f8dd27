package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1459:TextFieldManager;
      
      private var var_820:ICheckBoxWindow;
      ...
      private var var_1175:IWindowContainer;
      
      private var var_1704:IWindowContainer;
      
      private var var_1461:TextFieldManager;
      
      private var var_1701:Boolean;
      
      private var var_936:TextFieldManager;
      
      private var var_1462:ICheckBoxWindow;
      
      private var var_296:IWindowContainer;
      
      private var var_1000:TextFieldManager;
      
      private var var_471:int;
      
      private var var_1463:IWindowContainer;
      
      private var var_1174:IWindowContainer;
      
      private var var_935:TextFieldManager;
      
      private var var_2343:ITextWindow;
      
      private var var_470:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_575:Boolean;
      
      private var var_1703:IWindowContainer;
      
      private var var_1460:ICheckBoxWindow;
      ...
      private var var_1178:TextFieldManager;
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         if(var_575)
         {
            this.var_470.roomSettingsRefreshNeeded();
         }
      }
      
      private function clearErrors() : void
      {
         this.var_1000.clearErrors();
         this.var_1461.clearErrors();
         this.var_935.clearErrors();
         this.var_936.clearErrors();
         this.var_1178.clearErrors();
         this.var_1459.clearErrors();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_470.roomSettingsRefreshNeeded();
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_471));
      }
      
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         if(param1 != this.var_471 || var_1177 < 1)
         {
            return;
         }
         var_1177 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1324)
         {
            this.var_1000.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1380)
         {
            this.var_1000.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1287)
         {
            this.var_1461.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1350)
         {
            ...
            setTagError(this.var_936,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1264)
         {
            ...
            setTagError(this.var_936,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1315)
         {
            this.var_1178.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_1000.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function onEditUserDefinedRoomEventsButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.roomInfoViewCtrl.method_9();
      }
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_471);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_90.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_471]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_296.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_296.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_296.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_296.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_296.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_296.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_296.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_296);
         var_296.findChildByName("ruler").visible = true;
         ...
         if(var_90.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_296,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      private function populateForm() : void
      {
         ...
         var_1000.setText(_loc1_.name);
         var_1461.setText(_loc1_.description);
         var_1178.setText("");
         var_1459.setText("");
         ...
         setTag(var_936,_loc1_.tags[1]);
         if(var_1462)
         {
            if(_loc1_.allowPets)
            {
               this.var_1462.select();
            }
            else
            {
               this.var_1462.unselect();
            }
         }
         if(var_1460)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_1000.getText();
         _loc2_.description = var_1461.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_396;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_123)
         {
            _loc8_ = var_1178.getText();
            _loc9_ = var_1459.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1178.clearErrors();
               this.var_1459.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1462.isSelected;
         _loc2_.allowFoodConsume = var_1460.isSelected;
         _loc2_.allowWalkThrough = _allowWalkThroughCheckBox.isSelected;
         _loc2_.hideWalls = var_820.isSelected;
         _loc2_.tags = new Array();
         addTag(var_935,_loc2_.tags);
         addTag(var_936,_loc2_.tags);
         this.clearErrors();
         this.var_1177 = _loc2_.roomId;
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1704.visible = _inRoom;
         var_1703.visible = _inRoom;
         var_2342.visible = var_575;
         var_2343.visible = !var_575;
         if(var_575)
         {
            var_1176.visible = true;
            var_1281.visible = false;
            refreshFlatControllers();
            var_1176.height = Util.getLowestPoint(this.var_1176) + 4;
         }
         else
         {
            populateForm();
            var_1175.visible = true;
            var_1281.visible = true;
            var_1463.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1463.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1175.height = Util.getLowestPoint(this.var_1175) + 4;
         }
         var_1702.text = !!var_575 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1704.name,var_1463.name,var_1175.name,var_1176.name,var_1281.name,var_1703.name],0,0);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_703,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_1042,onDoorModePasswordUnselect);
         ...
         _window.findChildByName("edit_user_defined_room_events").visible = _navigator.configuration.getKey("userdefinedroomevents.enabled","IsOfferGiftableMessageEvent") == "true";
         this.var_1000 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1461 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_935 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_936 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1178 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1459 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1462 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1460 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this._allowWalkThroughCheckBox = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         this.var_820 = ICheckBoxWindow(_window.findChildByName("hide_walls_checkbox"));
         var_1704 = IWindowContainer(_window.findChildByName("header_container"));
         var_1463 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1175 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1176 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1703 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1281 = IWindowContainer(_window.findChildByName("footer_container"));
         var_296 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1174 = IWindowContainer(_window.findChildByName("password_container"));
         var_2343 = ITextWindow(_window.findChildByName("basic_caption"));
         var_2342 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1702 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1702.procedure = onSwitchView;
      ...
      {
         this.var_471 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_471));
         if(var_1174 != null)
         {
            var_1174.visible = false;
         }
