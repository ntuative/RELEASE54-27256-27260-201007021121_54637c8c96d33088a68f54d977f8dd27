package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_907 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_22.findChildByName("convo_bg"));
         _loc3_.bitmap = var_135.getButtonImage("convo_bg");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_135.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_135.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_135.conversations.startIndex > 0;
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         var_135.refreshButton(param1,param3,true,onTabClick,param2);
      }
      
      public function getTabCount() : int
      {
         return Math.floor(0 / var_1335);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_135.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_147 ? var_135.conversations.findConversation(param2.id) : var_135.conversations.openConversations[_loc3_ + var_135.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_135.conversations.setSelected(_loc4_);
         }
      ...
      {
         var_135.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         ...
         {
            _loc3_.bitmap = var_135.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         return var_135.conversations.openConversations.length - var_135.conversations.startIndex > getTabCount();
      }
      ...
      {
         var _loc3_:IWindowContainer = var_907.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
         refreshArrow(_loc3_,param1,param2);
         refreshTabBg(_loc3_,param1,!!param2 ? "tab_bg_next" : "tab_bg_unsel");
         var _loc4_:int = 0 % var_1335;
         _loc3_.width = var_1335 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = IWindowContainer(var_135.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
            var_907.addChild(_loc3_);
         }
         hideChildren(_loc3_);
         if(param2 == null)
         {
         ...
         _loc3_.x = param1 * var_1335;
         _loc3_.width = var_1335;
         return false;
      }
   }
}
