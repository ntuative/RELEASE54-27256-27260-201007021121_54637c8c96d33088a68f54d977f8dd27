package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1145:int = 10;
      
      private static const const_1144:int = 20;
      
      private static const const_808:int = 100;
       
      
      private var var_2230:IScrollbarWindow;
      
      private var var_135:HabboMessenger;
      
      private var var_1660:IContainerButtonWindow;
      
      private var var_562:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_135 = param1;
         var_1660 = initButton("follow_friend",onFollowButtonClick,param2);
         var_52 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2230 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_135.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_135.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_649 || param3.type == Message.const_713 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_562.messages.length - const_808);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_562.messages.length)
         {
            refreshEntry(true,_loc1_,var_562.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_562 == null || _loc1_.id != var_562.id)
         {
            var_562 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_808 + const_1144)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_135.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_135.send(new FollowFriendMessageComposer(var_562.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_135.getButtonImage(param1);
      ...
      {
         if(param1 == Message.const_649)
         {
            return 4294967295;
         }
         if(param1 == Message.const_713)
         {
            return 4292801535;
         }
         if(param1 == Message.const_963)
         {
            return 4294927974;
         }
         if(param1 == Message.const_753)
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_135.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_135.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1145;
         param1.invalidate();
      }
   }
}
