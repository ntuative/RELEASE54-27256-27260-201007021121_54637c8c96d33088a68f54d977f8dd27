package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1161:Number = 90;
      
      private static const const_771:int = 50;
      
      private static const const_1075:Number = 25;
      
      private static const const_1074:int = 50;
      
      private static const const_182:Boolean = true;
       
      
      private var var_599:Timer;
      
      private var var_1042:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1042 = param2;
         var_599 = new Timer(const_1075);
         var_599.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_490.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_490.splice(_loc3_,1);
            var_491.splice(_loc3_,1);
         }
         var_491.push(param1.name);
         var_490.push(param2);
         param1.addEventListener(WindowEvent.const_393,windowEventListener);
         param1.addEventListener(WindowEvent.const_230,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_490[var_491.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1042.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_307.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_307.splice(var_307.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1042.getIconLoc(param1.iconId);
      ...
      {
         return var_491[var_490.indexOf(param1)];
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_307.length)
         {
            repositionWindow(var_307[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_600[_loc3_] = new Array();
            }
            if(var_600[_loc3_].indexOf(param1) < 0)
            {
               var_600[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_771 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_771 || param1.desktop.height - param1.y < const_1074;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_491.length)
         {
            if(var_491[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_600[_loc3_].length)
                  {
                     repositionWindow(var_600[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
