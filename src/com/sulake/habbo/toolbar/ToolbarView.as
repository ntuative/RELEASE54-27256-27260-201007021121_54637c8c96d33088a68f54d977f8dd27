package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_212 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_52,HabboWindowStyle.const_927,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1131 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1131)
         {
            _window.addEventListener(WindowMouseEvent.const_48,onToolbarMouseDown);
         ...
         var_1372 = _loc7_.toolbar.@margin_bottom;
         var_1627 = _loc7_.toolbar.@min_group_margin;
         var_1628 = _loc7_.toolbar.@margin_to_extrabar;
         var_291 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_282,param1,param2,_window,var_291);
         createGroupsFromXmlList(_loc9_,var_654,param1,param2,var_212,var_291);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_142,var_553,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         var _loc6_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < var_282.length)
         {
            _loc3_ = var_282[_loc2_];
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1627,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1372) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1627,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1372) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_654.length)
         {
            _loc3_ = var_654[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_142,var_553);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_282.length)
         {
            _loc2_ = var_282[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_654.length)
         {
            _loc2_ = var_654[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_553);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_142,var_553);
         }
      }
