package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_313.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_37)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_135,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_968,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_163,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_178,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_43,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_506,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_638,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_946,onHideWindowEvent);
         var_37 = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_37 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_43)
            {
