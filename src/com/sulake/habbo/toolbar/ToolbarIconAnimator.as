package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1279 = param1.loop;
         if(param1.background != null)
         {
            var_875 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_874.push(new XML());
               var_876.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_876[var_53] = param6.clone();
         }
      ...
      {
         if(var_1279 == true || var_732 == 0)
         {
            if(false)
            {
               ++var_53;
               if(var_53 >= var_874.length)
               {
                  var_53 = 0;
                  ++var_732;
               }
      ...
      {
         return var_874.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1279 == false && var_732 == 1 && var_1439 != var_37;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_875 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_875.width),Math.max(param2.height,var_875.height));
            _loc3_.copyPixels(var_875,var_875.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_53 <= var_876.length)
         {
            _loc2_ = var_876[var_53];
