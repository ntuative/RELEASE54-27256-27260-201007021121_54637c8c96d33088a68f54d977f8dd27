package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_460:ToolbarBarMenuAnimator;
      ...
      public function get size() : Number
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_330.length)
         {
            if(var_330[_loc2_].exists)
            {
               _loc1_ += var_1427;
            }
            _loc2_++;
      ...
      {
         return var_1429.indexOf(param1) > -1;
      }
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_330.length)
         {
            _loc2_ = var_330[_loc3_];
            if(_loc2_ != null)
            {
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1428.length)
         {
            _loc2_ = var_792.indexOf(var_1428[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_330[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_870 + _loc3_);
                  _loc3_ += var_1427;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_460);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_330[var_792.indexOf(param1)];
      }
