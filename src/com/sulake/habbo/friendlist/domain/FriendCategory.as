package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_1038:int = 0;
      
      public static const const_429:int = -1;
      
      public static const const_339:int = 100;
      ...
      {
         return Math.ceil(this.var_249.length / const_339);
      }
      ...
      {
         if(this.var_934 >= this.getPageCount())
         {
            this.var_934 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_249.length)
         {
            _loc4_ = var_249[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_249.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_934 + 1) * const_339,this.var_249.length);
      }
