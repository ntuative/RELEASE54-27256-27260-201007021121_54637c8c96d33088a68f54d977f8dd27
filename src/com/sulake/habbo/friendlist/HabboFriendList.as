package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_147:String = "face";
      ...
      private var var_1577:OpenedToWebPopup;
      
      private var var_892:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_422:FriendListTabs;
      
      private var _localization:IHabboLocalizationManager;
      
      private var _view:FriendListView;
      
      private var var_135:IHabboMessenger;
      
      private var var_1578:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_620:ISessionDataManager;
      
      private var var_367:FriendRequests;
      
      private var var_1993:int;
      
      var var_95:FriendCategories;
      
      private var var_1994:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_891:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1994 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1578 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_367.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_367.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_422.findTab(FriendListTab.const_84).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_620 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_367 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_95.addCategory(new FriendCategory(FriendCategory.const_1038,getText("friendlist.friends")));
         var_95.addCategory(new FriendCategory(FriendCategory.const_429,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_95.addFriend(new Friend(_loc4_));
         }
         var_422 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_522)
         {
            var_522 = new Timer(120000);
            var_522.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_522.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_522.stop();
            var_522.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_522 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_135)
         {
            var_135.release(new IIDHabboMessenger());
            var_135 = null;
         }
         if(var_131)
         {
         ...
         if(var_892)
         {
            var_892.release(new IIDAvatarRenderManager());
            var_892 = null;
         }
         if(var_891)
         {
            var_891.release(new IIDHabboNotifications());
            var_891 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_620)
         {
            var_620.release(new IIDSessionDataManager());
            var_620 = null;
         }
         super.dispose();
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = _windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_34,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_135 = param2 as IHabboMessenger;
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_147) as IBitmapWrapperWindow;
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_82);
      ...
      {
         var _loc1_:String = var_131.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_422.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_324));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_82:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_341:
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1578.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_367.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_620.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_620.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_367.limit)
         {
            var_367.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_422.findTab(FriendListTab.const_84);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_892.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_367.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_422.findTab(FriendListTab.const_84);
      ...
      {
         return var_131.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1577 == null)
         {
            var_1577 = new OpenedToWebPopup(this);
         }
         var_1577.show(x,y);
      }
