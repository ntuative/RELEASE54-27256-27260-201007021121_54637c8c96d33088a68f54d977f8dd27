package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_624:String = "bg";
       
      
      private var var_2120:IContainerButtonWindow;
      
      private var var_2118:IContainerButtonWindow;
      
      private var var_2117:IContainerButtonWindow;
      
      private var var_2119:IContainerButtonWindow;
      
      private var var_387:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_387 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_2118 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2117 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2120 = initButton("room_invite",onInviteButtonClick,param1);
         var_2119 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_624);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_82,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_387.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_387.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_27)
         {
            this.var_387.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_255)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_255 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2118,isEnableMinimailButton(_loc1_));
         setEnabled(var_2117,isEnableHomeButton(_loc1_));
         setEnabled(var_2120,isEnableInviteButton(_loc1_));
         setEnabled(var_2119,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = var_52.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_624);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_82,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_82).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_82,param1);
      }
