package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsModel implements IInventoryModel
   {
      ...
      private var var_915:EffectListProxy;
      ...
      public function EffectsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager)
      {
         ...
         var_915 = new EffectListProxy(this,1);
         _inactiveEffectsProxy = new EffectListProxy(this,0);
         _view = new EffectsView(this,param2,param4,param5,var_915,_inactiveEffectsProxy);
      }
      ...
      private function getEffect(param1:int) : Effect
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_277.length)
         {
            _loc3_ = var_277[_loc2_];
      ...
      public function getEffects(param1:int = -1) : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_277.length)
         {
            _loc4_ = var_277[_loc3_];
      ...
      private function method_5(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_277.length)
