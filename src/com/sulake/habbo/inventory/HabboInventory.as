package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_879:IRoomSession;
      ...
      private const const_1741:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_21 != null)
         {
            var_21.events.removeEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionEvent.const_110,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_402,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_110:
               var_879 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_402:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_50.getValue(InventoryCategory.const_715));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_50.getValue(InventoryCategory.const_73));
      }
      ...
      {
         var_103.clubPeriods = param1;
         var_103.clubDays = param2;
         var_103.clubHasEverBeenMember = param3;
         var_103.isVIP = param4;
      ...
      {
         return PetsModel(var_50.getValue(InventoryCategory.const_144));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_857));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1741);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_50.getValue(InventoryCategory.const_349));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_254:
               _view.toggleCategoryView(InventoryCategory.const_73,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_880.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_880.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_50.getValue(InventorySubCategory.const_254));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_357 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_880.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_103.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_50.getValue(InventoryCategory.const_332) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1072 = new IncomingMessages(this);
      ...
      {
         return var_103.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_103.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_50.getValue(InventoryCategory.const_253));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionEvent.const_110,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionPropertyUpdateEvent.const_402,roomSessionEventHandler);
         ...
         var_50.add(InventoryCategory.const_332,_loc3_);
         ...
         var_50.add(InventoryCategory.const_73,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_357);
         var_50.add(InventoryCategory.const_253,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_50.add(InventoryCategory.const_715,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_357);
         var_50.add(InventoryCategory.const_349,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_50.add(InventorySubCategory.const_254,_loc8_);
         ...
         var_50.add(InventoryCategory.const_144,_loc10_);
