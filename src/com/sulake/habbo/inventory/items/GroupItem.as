package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1734:int = 13421772;
      ...
      protected var var_2427:BitmapData;
      ...
      protected var var_480:int = 0;
      
      protected var var_1484:String;
      
      private const const_1735:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_395:BitmapData;
      
      private const const_1480:Number = 0.2;
      
      protected var var_1486:Boolean;
      
      private const const_1481:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_539)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_38)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1574));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1484);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1480;
               _loc1_.blend = const_1480;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1486 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2427;
               _loc5_.visible = true;
            }
            else
            {
