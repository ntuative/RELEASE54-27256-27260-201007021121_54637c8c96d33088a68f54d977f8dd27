package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_547:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_547 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_664 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_664.getWithIndex(0));
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_56)
         {
            ...
            {
               case "tab_floor":
                  _model.switchCategory(FurniModel.const_38);
                  break;
               case "tab_wall":
                  _model.switchCategory(FurniModel.const_40);
            }
            selectPetsTab();
         }
      }
      ...
      {
         var _loc2_:PetsGridItem = var_664.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_547.removeGridItem(_loc2_.window);
         if(var_327 == _loc2_)
         {
            var_327 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_664.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_547.addGridItem(_loc2_.window);
            var_664.add(param1.id,_loc2_);
            if(var_327 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_49,this);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_30,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_30);
            _loc3_ = _loc12_.name;
