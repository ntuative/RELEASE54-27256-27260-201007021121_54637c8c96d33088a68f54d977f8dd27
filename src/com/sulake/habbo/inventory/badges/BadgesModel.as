package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1733:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_859.length)
         {
            if(var_859[_loc2_] == param1)
            {
               var_859.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_267.length)
         {
            _loc2_ = var_267[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_267.length)
               {
                  if((var_267[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_267[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_253 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_357.getBadgeImage(param1);
            var_267.push(_loc8_);
            if(param2)
            {
