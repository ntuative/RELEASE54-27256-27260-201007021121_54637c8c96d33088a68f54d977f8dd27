package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_596 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_596.width;
         var_97 = var_596.height;
         var_1036 = param5;
         var_847 = param6;
         var_227 = Math.floor(var_1036 / _thumbWidth);
         var_20 = new BitmapData(var_1036,var_847);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_227 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_227 - param1.x - 1;
         ...
         if(var_20.height < var_847)
         {
            _loc12_ = new BitmapData(var_20.width,var_847);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_596.width,var_596.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_596.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_596,var_596.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_487 = resolveRowCountFromList();
         if(var_487 == 0)
         {
            var_20 = new BitmapData(var_1036,var_847);
            return;
         }
         var_20 = new BitmapData(Math.max(var_227 * _thumbWidth,var_1036),Math.max(var_487 * var_97,var_847),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_487)
         {
            _loc4_ = 0;
            while(_loc4_ < var_227)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_227 && var_20.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_227 - 1),var_97);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_227 - 1),0,_thumbWidth,var_20.height);
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_227 - 1),0 - var_97);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_227));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_227);
         var _loc3_:int = param1 % var_227;
         return new Point(_loc3_,_loc2_);
      }
