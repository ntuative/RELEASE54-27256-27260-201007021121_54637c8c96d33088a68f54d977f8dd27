package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         var_27.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_73,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_715);
         _loc2_.refreshViews();
         var_14.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_172)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_38,_loc9_.category,_loc9_.stuffData);
      ...
      {
         var _loc2_:* = null;
         if(var_14.isInventoryCategoryInit(InventoryCategory.const_332))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_144);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_14.setInventoryCategoryInit(InventoryCategory.const_349);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_73);
         ...
         _loc4_.updateLocks();
         if(_loc4_.getSelectedItemIndex(FurniModel.const_38) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_38,0);
         }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_14.toggleInventorySubPage(InventorySubCategory.const_254);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_14.setInventoryCategoryInit(InventoryCategory.const_253);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_332);
         var _loc4_:FurniModel = var_14.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
