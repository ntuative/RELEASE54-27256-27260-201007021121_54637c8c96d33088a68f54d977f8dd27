package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_244 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_244.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_244 is FloorItem ? 1 : 2;
         var_2045 = _loc2_;
         var_2046 = var_244.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_244.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1592,var_1593);
         }
      }
      ...
      {
         if(param1 != var_2045 || param2 != var_2046)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1799);
      }
      ...
      {
         if(_controller != null && false && var_244 != null)
         {
            _controller.furniModel.removeLockFrom(var_244.id);
            var_244 = null;
         }
      }
