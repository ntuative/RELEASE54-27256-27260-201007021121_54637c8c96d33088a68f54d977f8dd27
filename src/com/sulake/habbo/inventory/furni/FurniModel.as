package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1152:int = 100;
      
      public static const const_304:String = "pets";
      
      public static const const_40:String = "wall";
      
      public static const const_38:String = "floor";
      ...
      private var var_806:IWindowContainer;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_241,onObjectPlaced);
         var_566 = new Timer(const_1152,1);
         var_566.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
         ...
         _view.switchCategory(const_38);
      }
      
      public function get isTradingOpen() : Boolean
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_254;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc8_:int = 0;
         var _loc6_:Array = [const_38,const_40];
         var _loc7_:int = 0;
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_462.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_462.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_539)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_241,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_566 != null)
            {
               var_566.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_566.stop();
               var_566 = null;
            }
            if(var_145 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_172)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_306)
         {
         ...
         else if(param3 == FurniCategory.const_312)
         {
         ...
         else if(param3 == FurniCategory.const_309)
         {
         ...
         if(var_806 == null)
         {
            var_806 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_806.clone() as IWindowContainer;
      ...
      public function method_2() : void
      {
         ...
         var _loc3_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_38,const_40];
         var _loc6_:int = 0;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_254:
               ...
               break;
            case InventorySubCategory.const_1013:
               method_2();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_332);
      ...
      {
         if(param1 == InventoryCategory.const_73 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_40:
                  ...
                  break;
               case const_304:
                  _controller.toggleInventoryPage(InventoryCategory.const_144);
            }
         }
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = getCategoryContent(const_40);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc8_:Array = [const_38,const_40];
         var _loc9_:int = 0;
      ...
      {
         if(var_983 && param1.type == RoomEngineObjectEvent.const_241)
         {
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_38,const_40];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function removeFurni(param1:int) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         var _loc7_:Array = [const_38,const_40];
         var _loc8_:int = 0;
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_309)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_462.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_462 = new Map();
         var_462.add(const_38,new Array());
         var_462.add(const_40,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
