package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_730:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_508 = new Map();
         var_508.add(FurniModel.const_38,new FurniGridView(_model,FurniModel.const_38,_windowManager,_assetLibrary,_roomEngine));
         var_508.add(FurniModel.const_40,new FurniGridView(_model,FurniModel.const_40,_windowManager,_assetLibrary,_roomEngine));
         ...
         switchCategory(FurniModel.const_38);
         ...
         else if(param1.type == WindowEvent.const_56)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_304);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_508.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModel.const_40:
               ...
               var_507 = FurniModel.const_40;
               break;
            case FurniModel.const_38:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               var_507 = FurniModel.const_38;
               break;
            case FurniModel.const_304:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               var_507 = FurniModel.const_304;
               break;
            default:
         ...
         var _loc4_:FurniGridView = var_508.getValue(var_507);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_38,FurniModel.const_40];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = var_508.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_507);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_306)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_312)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_309)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_172)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_730 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_508.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
