package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_815:uint = 4284532064;
      
      private static const const_816:uint = 2577770;
      ...
      private var var_191:Timer;
      
      private var var_387:ItemPopupCtrl;
      
      private var var_25:TradingModel;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_387 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
               ...
               case "button_accept":
                  switch(var_25.state)
                  {
                     case TradingModel.const_179:
                        if(var_25.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_958);
                        }
                        if(false)
                        {
                           var_25.requestUnacceptTrading();
                        }
                        else
                        {
                           var_25.requestAcceptTrading();
                        }
                        break;
                     case TradingModel.const_277:
                        param2.disable();
                        var_25.requestConfirmAcceptTrading();
                  }
                  break;
               case "button_cancel":
                  switch(var_25.state)
                  {
                     case TradingModel.const_179:
                        var_25.requestCancelTrading();
                        break;
                     case TradingModel.const_277:
                        var_25.requestConfirmDeclineTrading();
                  }
            }
         }
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_25.requestRemoveItemFromTrading(param2.id);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            _loc3_ = var_25.ownUserItems.getWithIndex(param2.id);
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = _loc3_.peek();
            _loc5_ = var_25.getItemImage(_loc4_);
            _loc6_ = "${roomItem.name." + _loc4_.type + "}";
            if(_loc4_.category == FurniCategory.const_172)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_834)
            {
            ...
            var_387.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_499);
            var_387.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_67.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_67.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            updateItemList(var_25.ownUserId);
         }
         _loc5_ = var_25.otherUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         while(_loc3_ < _loc5_.length)
         {
         ...
         if(_loc6_)
         {
            updateItemList(var_25.otherUserId);
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_25.otherUserItems.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_191)
            {
               var_191.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_191.stop();
               var_191 = null;
            }
            if(var_387 != null)
      ...
      {
         return var_67.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc9_:* = param1 == var_25.otherUserId;
         var _loc10_:Map = !!_loc9_ ? var_25.otherUserItems : var_25.ownUserItems;
      ...
      {
         var _loc2_:ITextWindow = var_67.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_67.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_67 == null)
         {
            var_67 = createNormalWindow();
         }
         if(var_1682 == null)
         {
            var_1682 = createMinimizedWindow();
         }
         if(!var_2282)
         {
            return var_67;
      ...
      {
         var _loc2_:ITextWindow = var_67.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_25.ownUserItems.length)
         {
            _loc2_ = var_25.ownUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_25.getFurniInventoryModel().displayItemInfo(_loc2_);
            }
         }
      }
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_27,ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_27,othersThumbEventProc);
            _loc6_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_25.otherUserItems.length)
         {
            _loc2_ = var_25.otherUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_25.getFurniInventoryModel().displayItemInfo(_loc2_);
      ...
      {
         var _loc1_:ITextWindow = var_67.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_67.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         if(var_191 == null)
         {
            var_191 = new Timer(1000,3);
            var_191.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_191.reset();
         var_191.repeatCount = 3;
         var_191.start();
      ...
      {
         var _loc1_:ITextWindow = var_67.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_67.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_67.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_25.otherUserName;
            }
            _loc1_ = var_67.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_815) : uint(const_816);
            }
            _loc3_ = var_67.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_67.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_815) : uint(const_816);
            }
            _loc3_ = var_67.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_67.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_67)
         {
            _loc1_ = var_67.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
            switch(var_25.state)
            {
               case TradingModel.const_164:
                  if(var_25.otherUserItems.length > 0 || var_25.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
