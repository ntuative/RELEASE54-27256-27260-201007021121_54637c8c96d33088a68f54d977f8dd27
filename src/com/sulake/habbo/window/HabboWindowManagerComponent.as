package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_365:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1108:uint = 1;
      ...
      private var var_2531:Array;
      
      private var var_245:IWindowContext;
      
      private var var_428:Array;
      
      private var var_1094:Boolean = false;
      
      private var var_1329:ProfilerAgentTask;
      
      private var var_1328:IEventDispatcher;
      
      private var var_2530:uint = 0;
      
      private var var_1330:ProfilerAgentTask;
      
      private var var_1327:ProfilerOutput;
      
      private var var_746:IWindowRenderer;
      ...
      {
         return var_240[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_240[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_745 = new SkinContainer(_loc3_.content as XML,assets);
         var_746 = new WindowRenderer(var_745);
         var_240 = new Array(const_365);
         var _loc5_:int = 0;
         while(_loc5_ < const_365)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_746,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_240[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_245 = var_240[const_1108];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_245.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_245.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1220,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_240[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_240.pop()).dispose();
            }
            var_240 = null;
            while(false)
            {
      ...
      {
         return var_240[param1].getDesktopWindow().getChildAt(var_245.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_428[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_428[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1327 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1327 = new ProfilerOutput(_loc3_,this,var_746);
               var_1329 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1329);
               var_1330 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1330);
               var_1094 = true;
            }
         }
      }
      ...
      {
         return var_245.getWindowParser().windowToXMLString(param1);
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return var_745.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         _loc2_ = 0;
         while(_loc2_ < const_365)
         {
            var_240[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1094)
         {
      ...
      {
         return var_245.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1410,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1303,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1398,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1420,param2.name + ": " + param2.toString());
            }
         }
      }
   }
