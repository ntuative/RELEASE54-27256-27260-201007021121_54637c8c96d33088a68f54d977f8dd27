package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1171:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1698:XML;
      
      private static var var_1700:XML;
       
      
      private var var_2488:IWindowContainer;
      ...
      private var var_1699:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1698 == null)
         {
            ...
            var_1698 = _loc4_.content as XML;
         }
         if(var_1700 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1699 == 4294967295)
            {
               var_1699 = _loc1_.color;
            }
            _loc1_.color = const_1171;
         }
      }
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,onIconImageReady);
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1373;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1698) as IWindowContainer;
         }
         else
         {
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(var_52);
            }
         }
         if(var_52 != null)
         {
      ...
      {
         var_52 = navigator.catalog.windowManager.buildFromXML(var_1700) as IItemListWindow;
         if(var_52 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1430;
            }
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(var_52);
            }
         }
         if(var_52 != null)
         {
