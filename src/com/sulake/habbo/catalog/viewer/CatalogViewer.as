package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1622:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_445 != null)
         {
            if(var_445.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_445.window);
            var_445.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1622);
         var_445 = _loc5_;
      ...
      {
         return var_445.dispatchWidgetEvent(param1);
      }
