package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1134:IButtonWindow;
      
      private var var_1133:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1134 != null)
         {
            var_1134.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1133 != null)
         {
            var_1133.removeEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1134 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1134 != null)
         {
            var_1134.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1133 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1133 != null)
         {
            var_1133.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
