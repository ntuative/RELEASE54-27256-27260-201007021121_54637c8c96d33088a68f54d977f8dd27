package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1392:XML;
      
      private var var_327:IGridItem;
      
      private var var_1391:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_947:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_780.length)
         {
            createLevelItem(var_780[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_947 = new PrizeViewer();
         var_780 = recycler.getPrizeTable();
         if(var_780 == null)
         {
            return;
         }
         ...
         var_1392 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_780[0].prizes.length > 0)
         {
            select(var_780[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1392) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1391) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_947.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
