package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_939:MarketPlaceOfferData;
      
      private const const_1483:int = 1;
      
      private const const_1745:int = 40;
      
      private var var_554:IWindowContainer;
      ...
      private const const_1746:int = 10;
      ...
      private function showDetails(param1:MarketPlaceOfferData) : void
      {
         ...
         {
            _loc9_ = getFurniImageResult(param1.furniId,param1.furniType,param1.stuffData);
      ...
      private function updateList() : void
      {
         ...
         if(!var_554)
         {
            ...
            var_554 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_554)
         {
            return;
         ...
         updateStatusDisplay(const_1484,_loc2_.length);
         if(!var_447)
         {
            var_447 = new Timer(25);
            var_447.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_938 = 0;
         populateList();
         var_447.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_603)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_554 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_554.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1483);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_448.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_447)
         {
            var_447.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_447 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_938 >= var_603.length)
            {
               return true;
            }
            addListItem(var_603.getWithIndex(var_938));
            ++var_938;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_939.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_131)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_448));
            _loc7_.selection = 0;
         }
      }
