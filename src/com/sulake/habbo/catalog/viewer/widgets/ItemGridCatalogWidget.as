package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            var_191.stop();
            var_191.removeEventListener(TimerEvent.TIMER,populateItemGrid);
            var_191 = null;
         }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_933 >= 0 && var_933 < page.offers.length)
            {
               _loc4_ = page.offers[var_933];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_489)
         {
            ++var_1623;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1623);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_145)
         {
            var_191 = new Timer(25);
            var_191.addEventListener(TimerEvent.TIMER,populateItemGrid);
            var_191.start();
         }
      }
