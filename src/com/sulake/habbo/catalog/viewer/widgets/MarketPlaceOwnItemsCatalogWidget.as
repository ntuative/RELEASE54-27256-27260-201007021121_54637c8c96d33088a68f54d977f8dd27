package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1484,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc10_ = _loc6_[_loc7_];
            _loc11_ = param1.getValue(_loc10_) as MarketPlaceOfferData;
            if(_loc11_.status == MarketPlaceOfferState.const_451)
            {
               _loc5_++;
            }
            _loc4_ = _itemTemplates.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_1010)
                  {
                  ...
                  {
                     _loc25_ = getFurniImageResult(_loc11_.furniId,_loc11_.furniType,_loc11_.stuffData);
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_943,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_451,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_1010,_loc2_);
            }
         }
