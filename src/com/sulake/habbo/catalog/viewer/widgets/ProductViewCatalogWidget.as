package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1685:Point;
      
      private var var_2290:Array;
      
      private var var_675:IItemGridWindow;
      
      private var var_89:IBitmapWrapperWindow;
      
      private var var_1361:ITextWindow;
      
      private var var_1448:IScrollbarWindow;
      
      protected var var_1391:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_675 != null)
         {
            ...
            var_675.destroyGridItems();
         }
         if(var_1448 != null)
         {
            var_1448.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1361.text = "${" + _loc3_.name + "}";
            var_1362.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1361.text = "${" + _loc2_.localizationId + "}";
            var_1362.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_32[_loc2_.localizationId]);
         }
         else
         {
            ...
            {
               case Offer.const_489:
                  _loc4_ = var_1449.clone();
                  if(var_675 != null)
                  {
                     var_675.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_675,var_1448,var_1391);
                  }
                  break;
               ...
               case Offer.const_444:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_243:
                        ...
                        _loc4_ = new BitmapData(var_89.width,var_89.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_49);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_41,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_283,AvatarAction.const_492);
                              _loc13_.appendAction(AvatarAction.const_423,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_30,true);
      ...
      {
         var_1361 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1362 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1685 = new Point(var_89.x,var_89.y);
         var_675 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1448 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_675 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1391 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1449 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_89);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_89 != null && true)
         {
            ...
            if(true)
            {
               var_89.bitmap = new BitmapData(var_89.width,var_89.height,true,16777215);
            }
            var_89.bitmap.fillRect(var_89.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_89.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_89.invalidate();
            var_89.x = var_1685.x;
            var_89.y = var_1685.y;
            if(param3 != null)
