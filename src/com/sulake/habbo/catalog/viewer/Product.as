package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1348:IProductData;
      ...
      {
         super();
         var_1349 = param1.productType;
         var_1350 = param1.furniClassId;
         var_1107 = param1.extraParam;
         var_1108 = param1.productCount;
         var_1351 = param1.expiration;
         var_1348 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_78:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1107);
               break;
