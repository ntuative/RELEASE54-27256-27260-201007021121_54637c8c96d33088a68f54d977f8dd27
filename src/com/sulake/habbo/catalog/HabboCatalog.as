package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_454:ClubBuyController;
      ...
      private var var_121:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_213:PurchaseConfirmationDialog;
      
      private var var_555:IHabboSoundManager;
      
      private var var_326:CatalogViewer;
      
      private var var_2186:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_455:ICatalogNavigator;
      ...
      private var var_2188:GiftWrappingConfiguration;
      ...
      private var var_1145:ClubGiftController;
      ...
      {
         return var_357.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2187 && var_555 != null)
         {
            var_555.playSound(HabboSoundTypesEnum.const_886);
         }
         var_2187 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_357.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_78)
         {
            _loc3_ = var_357.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_454 == null)
         {
            var_454 = new ClubBuyController(this);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_213.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_92:
               var_1409 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_131.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_131.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2188 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_957)
         {
            if(!var_357.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_224,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1145.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_455 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1145 == null)
         {
            var_1145 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_213 == null)
            {
               var_213 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_213.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_454.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_121.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_121 == null)
         {
            var_121 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_455.buildCatalogIndex(_loc2_);
         if(var_1144 != "")
         {
            var_455.openPage(var_1144);
            var_1144 = "";
         }
         else
         {
            var_455.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_171)
         {
            _loc3_ = var_131.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_326 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_326.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_326.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2186 && var_555 != null)
         {
            var_555.playSound(HabboSoundTypesEnum.const_913);
         }
         var_2186 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_326.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_326.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_326 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_326.habboCatalog = this;
      }
