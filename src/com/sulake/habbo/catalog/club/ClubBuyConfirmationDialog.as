package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_79:ClubBuyOfferData;
      ...
      {
         if(!param1 || !param2 || !_controller || !var_79)
         {
            return;
         }
         ...
         {
            case "select_button":
               _controller.confirmSelection(var_79,var_445);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc13_:int = var_79.periods == 0 ? 1 : int(var_79.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(var_79.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(var_79.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(var_79.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(var_79.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(var_79.daysLeftAfterPurchase));
         if(false)
         {
