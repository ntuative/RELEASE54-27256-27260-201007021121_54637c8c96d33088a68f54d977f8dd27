package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         _window = var_445.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!var_445 || true || !var_445.viewer.catalog || !var_445.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = var_445.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (var_445.viewer.catalog as HabboCatalog).getClubBuyController();
         (var_445.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_79,var_445);
      }
   }
}
