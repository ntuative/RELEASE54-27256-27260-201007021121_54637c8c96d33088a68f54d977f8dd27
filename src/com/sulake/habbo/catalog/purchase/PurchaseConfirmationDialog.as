package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1488:uint = 4.294967295E9;
      
      private const const_1489:uint = 4.293848814E9;
      
      private var var_846:int;
      
      private const const_1731:uint = 4.291613146E9;
      
      private var var_265:int = -1;
      ...
      private const const_1732:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_703:
               showSelectors(false);
               break;
            case WindowEvent.const_560:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_226.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_845;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_845,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1489) : uint(const_1488);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1505;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_80);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_445,var_79,var_1035);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_226.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_265) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_845);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_594[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_595[var_198]);
         _catalog.purchaseProductAsGift(var_445,var_79,var_1035,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_131:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_1739 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in var_249)
               {
                  ...
                  if(_loc5_.length >= const_1732)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1739 = _loc3_.text;
               break;
            case WindowMouseEvent.const_48:
               showSuggestions(false);
               if(var_1222)
               ...
               break;
            case WindowKeyboardEvent.const_743:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_265 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_265 + 1);
                     break;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_78:
                  ...
                  break;
               case ProductTypeEnum.const_243:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1505 = _loc1_.stuffTypes;
            var_594 = _loc1_.boxTypes;
            var_595 = _loc1_.ribbonTypes;
            var_845 = var_1505[0];
            _boxIndex = var_594[0];
            var_198 = var_595[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_226.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_265) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_265);
         }
         var_265 = param1;
         if(var_265 < 0)
         {
            var_265 = _loc2_.numListItems - 1;
         }
         if(var_265 >= _loc2_.numListItems)
         {
            var_265 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_265) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_226 == null)
         {
            var_226 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_486 == null)
         {
            var_486 = createWindow("suggestion_list_item") as IWindowContainer;
            var_486.procedure = suggestionsEventHandler;
         }
         if(var_226 == null || var_486 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_226.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_486.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
