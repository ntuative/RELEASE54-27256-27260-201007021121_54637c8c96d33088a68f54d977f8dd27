package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1554:uint = 13232628;
      
      private static var var_1926:uint = 11129827;
      ...
      private var var_301:IBorderWindow;
      
      private var var_882:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_363);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_363);
         }
         if(var_301 == null)
         {
            var_301 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_301 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_301);
            var_301.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_301.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_882 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_882.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1554;
