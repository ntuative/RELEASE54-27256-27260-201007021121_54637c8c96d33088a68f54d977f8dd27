package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1478:int = 0;
      
      private static const const_1477:int = 0;
      ...
      private var var_2073:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","27256-27260-201007021103");
         _toolbar = param5;
         var_111 = new Map();
         var_111.add(HabboHelpViewEnum.const_1362,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_149,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_388,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_251,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_231,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_749,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_327,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_656,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_237,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_111.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_111.add(HabboHelpViewEnum.const_885,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_748,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1602 = 0 - _loc3_.width;
         var_1601 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_149 || false)
         {
            return;
         }
         if(var_435 == null)
         {
            ...
            var_435 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_435 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_435 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_435 as IWindow);
      ...
      {
         return var_111.getValue(var_276);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_111.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_111.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_2075 = param1;
         var _loc2_:IHelpViewController = var_111.getValue(HabboHelpViewEnum.const_149) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_237:
               showUI(HabboHelpViewEnum.const_237);
               break;
            case CallForHelpResultEnum.const_887:
               showUI(HabboHelpViewEnum.const_885);
               break;
            case CallForHelpResultEnum.const_950:
      ...
      {
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_149)
         {
            return;
         }
         if(true)
         {
            ...
            var_643.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_643.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_435.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_643[1],var_643[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_643[0],var_643[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1601;
         _window.width = _loc1_.width + var_1602;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_111.length)
         {
            _loc3_ = var_111.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_276);
            return;
         }
         ...
         if(_loc3_)
         {
            if(_toolbar != null)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_24.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_445));
      }
