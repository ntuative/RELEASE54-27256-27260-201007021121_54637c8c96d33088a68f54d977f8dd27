package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private var var_613:IWindowContainer;
      ...
      private function showSelectionView() : void
      {
         if(!var_613)
         {
            var_613 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_613)
            {
               return;
            }
            _window.content.addChild(var_613);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_301)
         {
            var_301 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_301)
            {
               return;
            }
            _window.content.addChild(var_301);
         }
         _window.caption = _controller.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_301.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_363;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1290 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_882 = new NameSuggestionListRenderer(_controller);
