package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1137:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_781 == null || _loc3_ < 0 || _loc3_ >= var_781.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_781[_loc3_];
            main.showUI(HabboHelpViewEnum.const_656);
            main.tellUI(HabboHelpViewEnum.const_656,null);
         }
      }
   }
}
