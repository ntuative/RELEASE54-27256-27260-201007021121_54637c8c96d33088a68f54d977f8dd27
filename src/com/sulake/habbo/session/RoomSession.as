package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_37:String = "RSE_CREATED";
      
      private var var_1089:UserDataManager;
      ...
      {
         if(var_37 == RoomSessionEvent.const_323 && _connection != null)
         {
            var_37 = RoomSessionEvent.const_92;
            if(isPrivateRoom)
            {
               return sendOpenFlatConnectionMessage();
            }
            return method_4(_roomId,0,true);
         }
         return false;
      }
      ...
      private function method_4(param1:int, param2:int, param3:Boolean) : Boolean
      {
         if(_connection == null)
         {
            return false;
      ...
      {
         return var_1089 as IUserDataManager;
      }
