package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      public function RoomUsersHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new NewBuddyRequestEvent(onFriendRequest));
      }
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_100,_loc3_,_loc2_.userName));
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id >= 0)
         {
            ...
            listener.events.dispatchEvent(new RoomSessionUserFigureUpdateEvent(_loc3_,_loc2_.id,_loc2_.figure,_loc2_.sex));
         }
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_39);
         if(_loc4_ == null)
         {
            return;
         }
