package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_196:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_217:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_194:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_157:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_206:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_210:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_229:
               _loc4_ = "null";
               break;
            default:
               return;
