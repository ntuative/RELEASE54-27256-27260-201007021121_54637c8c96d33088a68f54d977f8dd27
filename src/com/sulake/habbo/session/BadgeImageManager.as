package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1289:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_971:String = "group_badge";
       
      
      private const const_1482:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1482,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1482 + param1;
         ...
         switch(param2)
         {
            case const_1289:
               if(var_131 != null)
               {
                  _loc5_ = var_131.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_971:
               if(var_131 != null)
               {
                  if(var_131 != null)
                  {
                     _loc5_ = var_131.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,onBadgeImageReady);
         }
