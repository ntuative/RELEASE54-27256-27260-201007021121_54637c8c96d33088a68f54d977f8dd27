package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_299;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_729);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_590);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_661);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_122:
               ...
               break;
            case FriendRequestEvent.const_51:
            case FriendRequestEvent.const_258:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_729:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_590:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_661:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_122);
         _loc1_.push(FriendRequestEvent.const_51);
         _loc1_.push(FriendRequestEvent.const_258);
         return _loc1_;
      }
