package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_455,RoomWidgetPollMessage.const_665];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_115:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_115);
            ...
            case RoomSessionPollEvent.const_58:
               ...
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_137:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_137);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_665:
               _container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_455:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionPollEvent.const_115);
         _loc1_.push(RoomSessionPollEvent.const_58);
         _loc1_.push(RoomSessionPollEvent.const_137);
         return _loc1_;
      }
