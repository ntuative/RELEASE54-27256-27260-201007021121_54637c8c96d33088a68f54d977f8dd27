package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_626:
               if(_container != null && false && _container.toolbar.events != null)
               {
                  _loc7_ = new HabboToolbarEvent(HabboToolbarEvent.const_55);
            ...
            case RoomWidgetWaveMessage.const_698:
               ...
               break;
            case RoomWidgetDanceMessage.const_680:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_728:
               if(var_14 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_677:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_536:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_651:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_983)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_689:
               ...
               if(var_14 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_969:
                        _catalog.openCatalogPage(CatalogPageName.const_1342,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1040:
                        var_14.toggleInventoryPage(InventoryCategory.const_253);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1407:
                        var_14.toggleInventoryPage(InventoryCategory.const_73);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1364:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_579:
            case RoomWidgetStopEffectMessage.const_601:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_939:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1250:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_936:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_577:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_686:
               ...
               if(_toolbar)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_14 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_716:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_506,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_308:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_486));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_706:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_588:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_690:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_667:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_411));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_331:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_615));
               break;
            default:
      ...
      {
         return RoomWidgetEnum.const_469;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_383:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_450));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_741,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_741,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_155,onCreditBalance);
         }
         var_14 = _container.inventory;
         if(var_14 != null)
         {
            (var_14 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_857,onAvatarEffectsChanged);
            (var_14 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1029,onHabboClubSubscriptionChanged);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_680);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_728);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_677);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_536);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_579);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_689);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_651);
         _loc1_.push(RoomWidgetStopEffectMessage.const_601);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1347);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_936);
         _loc1_.push(RoomWidgetToolbarMessage.const_686);
         _loc1_.push(RoomWidgetToolbarMessage.const_716);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_308);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1211);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_873);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_577);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_626);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_706);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1440);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_588);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_690);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_667);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_331);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_735));
      }
