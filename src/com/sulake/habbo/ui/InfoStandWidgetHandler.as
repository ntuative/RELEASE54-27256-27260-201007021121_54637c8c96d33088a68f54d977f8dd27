   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_151,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_113,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_148,onFigureUpdate);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_151,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_113,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_148,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_700);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_333);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1006);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_926);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_242)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_307)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_875)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_202)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_542);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1367;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_862;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1036;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1297);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_49,_loc18_);
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_30,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_30,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_49,param1.gender);
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_30,4);
               _loc4_ = _loc5_.getImage(AvatarSetType.const_30,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_652.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_49);
            var_652.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_30),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_542);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_125];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_632);
         _loc1_.push(RoomWidgetUserActionMessage.const_764);
         _loc1_.push(RoomWidgetUserActionMessage.const_694);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_660);
         _loc1_.push(RoomWidgetUserActionMessage.const_671);
         _loc1_.push(RoomWidgetUserActionMessage.const_610);
         _loc1_.push(RoomWidgetUserActionMessage.const_591);
         _loc1_.push(RoomWidgetUserActionMessage.const_733);
         _loc1_.push(RoomWidgetFurniActionMessage.const_274);
         _loc1_.push(RoomWidgetFurniActionMessage.const_704);
         _loc1_.push(RoomWidgetFurniActionMessage.const_556);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_532);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_675);
         _loc1_.push(RoomWidgetUserActionMessage.const_389);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_738);
         _loc1_.push(RoomWidgetPetCommandMessage.const_562);
         _loc1_.push(RoomWidgetUserActionMessage.const_683);
         _loc1_.push(RoomWidgetUserActionMessage.const_501);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_125:
      ...
      public function dispose() : void
      {
         ...
         if(var_652 != null)
         {
            _loc1_ = var_652.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_652.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return RoomWidgetEnum.const_428;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_389)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_632:
               _container.friendList.askForAFriend(_loc2_,_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_764:
               _container.sessionDataManager.giveRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_683:
               _container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_694:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1018,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_502:
               ...
               break;
            case RoomWidgetUserActionMessage.const_660:
               _container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_671:
            ...
            case RoomWidgetUserActionMessage.const_610:
               ...
               break;
            case RoomWidgetUserActionMessage.const_591:
               ...
               break;
            case RoomWidgetUserActionMessage.const_733:
            ...
            case RoomWidgetRoomTagSearchMessage.const_532:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_675:
               ...
               break;
            case RoomWidgetUserActionMessage.const_389:
