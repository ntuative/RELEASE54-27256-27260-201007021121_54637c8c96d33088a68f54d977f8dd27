package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_596:String = "InitConnection";
      ...
      private var var_192:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_123:SSOTicket;
      ...
      {
         var_192.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_192.shockwaveClientUrl = var_123.shockwaveClientUrl;
         var_192.ssoTicket = var_123.ticket;
         var_123.removeEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_123.removeEventListener(SSOTicket.const_266,onParsedTicketFailure);
         var_123 = null;
         dispatchEvent(new Event(const_596));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1485,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_192 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_192.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_107,HabboWindowStyle.const_34,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_192.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1485,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_192.habboConfiguration.getKey("use.sso","IsOfferGiftableMessageEvent") == "true")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_192.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_192.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_192.habboCommunication.habboWebLogin(name,password);
         var_123 = new SSOTicket(var_192.assets,_loc2_,_loc1_);
         var_123.addEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_123.addEventListener(SSOTicket.const_266,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_192.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_192.windowManager.buildFromXML(_loc3_.content as XML);
