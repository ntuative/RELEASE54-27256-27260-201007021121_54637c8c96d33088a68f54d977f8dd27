package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_187:HabboHotelView;
      ...
      private var var_2172:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1649:ILogger;
      
      private var var_1405:String;
      
      private var var_2174:String;
      
      private const const_1485:String = "fuselogin";
      
      private var var_313:ICoreCommunicationManager;
      
      private var var_450:IKeyExchange;
      ...
      private var var_64:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1142)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_174);
         }
         var_2173 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2173)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_788 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_788);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_158);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         var_1142 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_236);
         connection.send(new VersionCheckMessageComposer(401,var_1405,var_2174));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1485,"/");
      ...
      {
         var _loc4_:IConnection = var_64.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_450.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_450.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2172);
      ...
      {
         var_788 = _habboConfiguration.getKey("sso.ticket",null);
         var_1405 = _habboConfiguration.getKey("flash.client.url","");
         var_2174 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_187 == null)
         {
            var_187 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_788 != null)
         {
            var_64.mode = HabboConnectionType.const_386;
            var_64.initConnection(HabboConnectionType.const_259);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1649 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_64 = param2 as IHabboCommunicationManager;
            _loc3_ = var_64.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_64.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_64.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_64.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_64.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_64.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_64.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_64.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_64.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_64.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_64.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_64.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_64.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
            var_64.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_64.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_758);
            _loc3_ = new InitCryptoMessageComposer(var_64.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2172 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_386:
               _loc6_ = "";
               ...
               var_1143 = _loc4_;
               var_187.loadBannerImage(_loc7_ + "?token=" + var_1143,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1002:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1446:
               var_661 = generateRandomHexString(30);
               var_450 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_450.init(var_661);
               _loc8_ = var_450.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_187.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1143);
         ...
         var _loc9_:IConnection = var_64.getHabboMainConnection(null);
         ...
         var_450 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_450.init(_loc14_);
            _loc15_ = var_450.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_1002;
            }
         }
         var_64.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_162,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_110,onRoomSessionEnded);
      }
