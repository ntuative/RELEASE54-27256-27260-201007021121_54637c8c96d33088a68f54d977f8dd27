package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_105);
            if(_loc2_ != null && _loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_105,"");
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_118,_loc3_,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(var_1259)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_90,_loc1_,_loc2_);
