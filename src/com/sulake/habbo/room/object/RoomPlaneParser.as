package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_833:Number = 0.0;
      
      private var var_354:int = 0;
      
      private var var_352:int = 0;
      
      private var var_1230:Number = 0.0;
      ...
      private var var_853:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_994;
         }
         var _loc2_:RoomPlaneData = var_107[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.type;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_153,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_249,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_853);
         addPlane(RoomPlaneData.const_153,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_153,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_153,Vector3d.sum(param1,Vector3d.product(param3,-_floorThickness / param3.length)),Vector3d.product(param3,(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_853 / param2.length);
               addPlane(RoomPlaneData.const_153,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || var_106 == null || param1 == var_106)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_106.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = var_106[_loc3_] as Array;
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_106[param2] as Array;
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = var_107[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_106);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var_833 = getFloorHeight(var_106);
         if(!param1)
         {
            createWallPlanes();
         }
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < var_106.length)
         {
            _loc4_ = var_106[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            _loc4_ = var_106[param2] as Array;
            ...
            {
               if(param1 == var_352 || param1 == var_355)
               {
                  _loc5_ = false;
                  _loc6_ = var_354;
                  while(_loc6_ < var_353)
                  {
               ...
               if(param2 == var_354 || param2 == var_353)
               {
                  _loc7_ = false;
                  _loc8_ = var_352;
                  while(_loc8_ < var_355)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_156,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_156,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_156,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_156,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_156,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
