package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1098:String = "shore";
      ...
      private var var_1563:Boolean = true;
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = var_514 + 2;
         var _loc4_:int = var_614 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               var_515[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function resetBorders() : void
      {
         ...
         if(var_514 == 0 || var_614 == 0)
         {
            ...
            var_514 = _loc2_.getNumber(RoomObjectVariableEnum.const_293);
            var_614 = _loc2_.getNumber(RoomObjectVariableEnum.const_318);
         }
         var_364 = [];
         var_515 = [];
         var _loc1_:int = 0;
         while(_loc1_ < var_514 * 2 + var_614 * 2)
         {
            var_364.push(false);
            var_515.push(ShoreMaskCreatorUtility.const_71);
            _loc1_++;
         }
      }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               var_515[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc1_:int = var_514 + 2;
         var _loc2_:int = var_614 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(var_1937 == param1 && var_1936 == _direction)
         {
            return var_1562;
         }
         var_1937 = param1;
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1098)
            {
               var_1562 = _loc2_;
               break;
            }
      ...
      {
         if(var_62 == null || var_62.width < param1 || var_62.height < param2)
         {
            if(var_62 != null)
            {
               var_62.dispose();
            }
            var_62 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(var_62,getSize(param3),var_364,var_515,assetCollection);
      }
