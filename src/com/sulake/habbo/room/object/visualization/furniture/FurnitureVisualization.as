package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1453:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2425:int = -1;
      ...
      protected var var_1676:String = null;
      ...
      private var var_2071:Number = 0.0;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_640[param1] = _loc3_;
            var_641[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1676 != null && var_1676.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2425,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2072 != param1 || var_2071 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_640[_loc3_] = "";
               var_641[_loc3_] = false;
               _loc3_--;
            }
            var_2072 = param1;
            var_2071 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2070 != param1 || var_2069 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2425 = _loc3_.getNumber(RoomObjectVariableEnum.const_232);
            ...
            var_1676 = _loc3_.getString(RoomObjectVariableEnum.const_317);
