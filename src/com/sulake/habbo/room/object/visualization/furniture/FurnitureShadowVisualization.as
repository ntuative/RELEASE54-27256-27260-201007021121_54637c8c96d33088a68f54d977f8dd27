package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureShadowVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2424:Number = NaN;
      ...
      private function updateSprites(param1:int, param2:Number) : void
      {
         ...
         if(_loc5_ != null)
         {
            if(_loc4_ != null && _loc4_.asset != null)
            {
               ...
               {
                  _loc6_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_211);
               }
               _loc5_.alpha = _loc6_;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_306 != _loc3_.getUpdateID() || param1 != var_157 || param2 != var_2424)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_306 = _loc3_.getUpdateID();
            var_2424 = param2;
            return true;
         }
         return false;
