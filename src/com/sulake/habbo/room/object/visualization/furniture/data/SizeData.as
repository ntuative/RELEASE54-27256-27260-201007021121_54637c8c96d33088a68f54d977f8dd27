package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_321:int = 1000;
      ...
      private var var_1325:int = 360;
      
      private var var_2013:int = 0;
      
      private var var_744:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1325 / 2) % 360 / var_1325;
         if(var_239.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_239.length)
         {
            _loc6_ = int(var_239.getKey(_loc5_)) * var_1325;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_239.getKey(_loc4_));
         }
         return const_1302;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_919);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_844);
                  break;
               case "DARKEN":
      ...
      {
         var _loc3_:* = null;
         _loc3_ = getDirectionData(param2);
         if(_loc3_ != null)
         {
            return _loc3_.getZOffset(param1);
         }
         return LayerData.const_509;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_239.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_239 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < var_239.length)
            {
               _loc2_ = var_239.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_239.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_239.add(String(_loc7_),_loc3_);
            var_1326 = -1;
            var_744 = null;
            _loc5_++;
         }
