package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      {
         return param1 + param2 * const_1167;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_116,const_71,const_62,const_116,const_71,const_62];
                     _loc8_ = [const_71,const_71,const_71,const_62,const_62,const_62];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
                        ...
                        _loc9_ = createMaskRight(_loc6_.width,_loc6_.height);
                        cutRightMaskInnerCorner(_loc9_,param1);
                        cutRightMaskOuterCorner(_loc9_,param1,false);
                     }
                  }
