package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_247:PlaneBitmapData = null;
      
      private var var_764:IPlaneRasterizer = null;
      ...
      private var var_662:PlaneMaskManager = null;
      ...
      private var var_1615:Boolean = true;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(var_926)
         {
            ...
            {
               _loc4_ = var_211[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_102 || _type == const_87))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_926 || false && false && !var_160 || var_662 == null)
         {
            return;
         }
         ...
         if(var_160)
         {
            ...
            while(_loc5_ < var_211.length)
            {
               _loc3_ = var_211[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = 0 - 0 * _loc3_.leftSideLoc / 0;
                  _loc11_ = 0 - 0 * _loc3_.rightSideLoc / 0;
                  _loc12_ = _loc3_.type;
                  var_662.updateMask(var_62,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_763.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_278.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1122.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_160 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_764 != null)
         {
            return var_764.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_102 || _type == const_87)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            ...
            {
               _loc4_ = var_211[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < var_763.length)
                  {
                     _loc7_ = var_763[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1295.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1295[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = var_247;
         if(_loc3_ == null)
         {
         ...
         updateMaskChangeStatus();
         if(var_765 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_160))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_764 != null)
            {
               _loc3_ = var_764.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1615,var_2102,var_2099,var_2103,var_2101,param2);
               if(_loc3_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(var_183 != null && (var_183.width != param1.width || var_183.height != param1.height))
         {
            var_183.dispose();
            var_183 = null;
         }
         if(var_183 == null)
         {
            var_183 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         var_183.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         var_183.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(var_183,var_183.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
