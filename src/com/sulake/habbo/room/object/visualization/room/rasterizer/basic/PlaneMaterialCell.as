package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_573:PlaneTexture;
      
      private var var_819:Array;
      
      private var var_1171:int = 0;
      
      private var var_26:BitmapData = null;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_573 != null)
         {
            _loc2_ = var_573.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  if(var_26 != null)
                  {
                     if(var_26.width != _loc2_.width || var_26.height != _loc2_.height)
                     {
                        var_26.dispose();
                        var_26 = null;
                     }
                     ...
                     {
                        var_26.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(var_26 == null)
                  {
                  ...
                  _loc3_ = Math.min(var_1171,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_1171,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_1171,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_819[_loc6_ % 0] as IGraphicAsset;
