package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_511:String = "default";
      ...
      private var var_334:Map = null;
      
      private var var_1004:IGraphicAssetCollection = null;
      
      private var var_107:Map = null;
      ...
      private function include(param1:XML) : Array
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_1004.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_180.getValue(_loc6_) == null)
               {
      ...
      {
         return var_334.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_107 != null)
         {
            ...
            {
               _loc2_ = var_107.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_334.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_180.getValue(param1) as PlaneTexture;
      }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = var_180.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      private function parsePlaneMaterialCellColumn(param1:XML, param2:PlaneMaterialCellMatrix, param3:int) : void
      {
         ...
         var _loc7_:Array = include(param1);
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(var_107.getValue(param1) == null)
         {
            var_107.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_334.length)
         {
            _loc3_ = var_334.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
