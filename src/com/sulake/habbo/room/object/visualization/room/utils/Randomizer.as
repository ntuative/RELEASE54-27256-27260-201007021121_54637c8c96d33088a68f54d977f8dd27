package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1694:int = 16777216;
      
      public static const const_1583:int = 1;
       
      
      private var var_2502:int = 69069;
      
      private var var_1292:int = 1;
      
      private var var_2503:int = 5;
      
      private var var_1555:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1555 * param2);
      }
      ...
      {
         var _loc1_:int = var_2502 * var_1292 + var_2503;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
