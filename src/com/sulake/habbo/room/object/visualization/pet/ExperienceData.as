package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      private var var_852:BitmapDataAsset;
      ...
      {
         super();
         var_852 = param1.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
      }
      ...
      public function setExperience(param1:int) : void
      {
         ...
         _image = (var_852.content as BitmapData).clone();
