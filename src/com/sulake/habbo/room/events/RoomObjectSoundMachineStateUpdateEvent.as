package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_871:String = "ROSM_SOUND_MACHINE_SWITCHED_ON";
      
      public static const const_1232:String = "ROSM_JUKEBOX_INIT";
      
      public static const const_1254:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_980:String = "ROSM_DISPOSE";
