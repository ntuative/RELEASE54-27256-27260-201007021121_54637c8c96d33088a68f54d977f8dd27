package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_518:String = "room";
      
      private static const const_798:int = -2;
      
      private static const const_519:String = "temporary_room";
      
      private static const const_298:String = "object_icon_sprite";
      
      private static const const_799:int = -3;
      
      private static const const_800:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1115:String = "tile_cursor";
      
      private static const const_297:int = -1;
      ...
      private var var_637:NumberBank;
      ...
      private var var_753:RoomMessageHandler = null;
      
      private var var_752:IRoomRendererFactory = null;
      
      private var var_2053:Boolean = false;
      
      private var var_119:int = 0;
      
      private var var_1104:Map;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_321 = new Map();
         var_637 = new NumberBank(1000);
         var_1104 = new Map();
         var_322 = new Map();
         var_69 = new RoomObjectEventHandler(this);
         var_753 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_69 != null)
         {
            ...
            {
               return var_69.deleteWallItem(var_118,var_119,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_321.length; _loc2_++)
         {
            _loc3_ = var_321.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_559) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_635) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_602) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_535) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return var_69.modifyWallItemData(var_118,var_119,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_464 != null)
         {
            var_464.release(new IIDRoomObjectVisualizationFactory());
            var_464 = null;
         }
         if(var_43 != null)
         {
         ...
         if(var_752 != null)
         {
            var_752.release(new IIDRoomRendererFactory());
            var_752 = null;
         }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_321.length)
            {
               _loc2_ = var_321.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_752.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_974;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_573);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_582);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_533);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_840);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_916);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_922) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_893);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_401,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_527,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_726,var_118,var_119,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_69 != null)
         {
            return var_69.modifyRoomObject(var_118,var_119,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_322.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_322.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_603,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_561,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_714,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_43 != null)
         {
            ...
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_281);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_69 != null)
         {
            var_69.handleRoomObjectEvent(param1,var_118,var_119);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_15.sessionDataManager = var_357;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_232,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_333,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_317,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_996,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1006,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_926,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_719,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_28 == null || var_464 == null || var_43 == null || var_752 == null || _communication == null || _habboConfiguration == null || !var_2053)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_297,RoomObjectCategoryEnum.const_63);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1275,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_43.getRoom(getRoomIdentifier(var_118,var_119));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_799,RoomObjectCategoryEnum.const_281);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_118,var_119,var_1347);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_118,var_119,var_1347);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_15 != null)
         {
            var_15.visualizationFactory = var_464;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_233,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_380,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_422,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_170,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_720,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_90,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_443,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_395,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_416,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_379,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_413,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_434,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_490,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_418,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_57,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_477,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_425,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_263,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_407,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_351,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_347,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_446,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_1049,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_462,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_466,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_634) != 0)
         {
            return false;
         }
         if(var_69 != null)
         {
            return var_69.initializeRoomObjectInsert(var_118,var_119,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_533 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_754,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_322.length)
            {
               _loc3_ = var_322.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1051,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1024,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_232));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_472);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_176);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_353);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_695)
         {
            var_2053 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_232,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_333,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_317,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_974,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_427,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_800) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_321.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_653,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_752 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_533 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_43.getRoom(const_519);
         if(_loc10_ == null)
         {
            _loc10_ = var_43.createRoom(const_519,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_637.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_232,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_472,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_176,param2);
               break;
            case RoomObjectCategoryEnum.const_63:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_156,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_153,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_153,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_249,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_551,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_654,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_688,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_401,_loc24_,param6,new Vector3d(2,0,1.75));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_798,RoomObjectCategoryEnum.const_281);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1598 - _loc12_.width / 2;
               _loc11_.y = var_1599 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_476,var_118,var_119,-1,RoomObjectCategoryEnum.const_191));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_69 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_297,const_518);
                  var_69.handleRoomObjectEvent(_loc14_,var_118,var_119);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_118,var_119,var_1347);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1598 - _loc6_.data.width / 2;
               _loc11_.y = var_1599 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_15 != null)
         {
            ...
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_352,param1.image,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_883,param1.adWarningL,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_965,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1005,RoomObjectVariableEnum.const_352,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_321.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_321.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_15 != null)
         {
            _events.addEventListener(RoomContentLoader.const_695,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_69 != null)
         {
            var_69.cancelRoomObjectInsert(var_118,var_119);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_43.getRoom(const_519);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               var_637.freeNumber(_loc10_ - 1);
               _loc13_ = var_1104.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_118,var_119,const_297,RoomObjectCategoryEnum.const_63,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_297,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1023,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_634,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_995,_loc13_,true);
            if(var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_297,const_518,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_634,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_573,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_559,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_602,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_635,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_535,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_904,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_603,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_561,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_714,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_401,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_201);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_582,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_533,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_582,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_533,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_840,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_916,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_798,const_1115,RoomObjectCategoryEnum.const_281);
         _loc7_.createRoomObject(const_799,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_281);
         return _loc7_;
      }
