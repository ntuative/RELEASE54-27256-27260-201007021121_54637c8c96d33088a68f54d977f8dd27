package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_293);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_742);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_962);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_599);
         }
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_124:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_124,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_129:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_129,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_119:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_119,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_118:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_118,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_90:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_90,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_127:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_127,param2,param3,_loc4_,_loc6_));
            }
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_418:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1232));
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_980));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_28 || _loc5_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc8_ = _loc12_.x;
                  _loc9_ = _loc12_.y;
               }
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_33 && _loc3_.typeId == RoomObjectTypeEnum.const_242)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_241,param1,param2,_loc4_,_loc5_));
         }
      ...
      private function handleObjectDimmerStateEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectDimmerStateUpdateEvent.const_57:
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.ROOM_OBJECT_SELECTED,param1,param2,param3,param4));
         }
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_211,param2);
         }
      }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            if(_loc5_.category == RoomObjectCategoryEnum.const_28 && _loc8_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_28)
            {
               if(_loc6_ != null)
               {
                  if(_loc6_.getModel() != null)
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_599);
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc7_ == RoomObjectCategoryEnum.const_28)
            {
               if(!param6)
               {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_191,MouseEvent.CLICK);
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_63)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_33)
                  {
                     if(_loc10_ != null)
                     {
                        setMouseEventId(RoomObjectCategoryEnum.const_63,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_63)
         {
            _loc12_ = getMouseEventId(RoomObjectCategoryEnum.const_63,MouseEvent.CLICK);
            if(_loc12_ != _loc10_)
            {
               _loc13_ = _roomEngine.events;
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_476,param2,param3,-1,RoomObjectCategoryEnum.const_191));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function useObject(param1:int, param2:int, param3:int, param4:String, param5:String) : void
      {
         if(_roomEngine != null && false)
         {
            switch(param5)
            {
               case RoomObjectFurnitureActionEvent.const_443:
                  _roomEngine.connection.send(new ThrowDiceMessageComposer(param3));
                  break;
               case RoomObjectFurnitureActionEvent.const_395:
                  _roomEngine.connection.send(new DiceOffMessageComposer(param3));
                  break;
               case RoomObjectFurnitureActionEvent.const_416:
               ...
               case RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE:
                  ...
                  break;
               case RoomObjectFurnitureActionEvent.const_379:
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_28 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_548,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_293);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_318);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:int, param4:int, param5:String) : Boolean
      {
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(false)
               {
                  if(param4 == RoomObjectCategoryEnum.const_28)
                  {
                  ...
                  else if(param4 == RoomObjectCategoryEnum.const_26)
                  {
                     ...
                     if(false && _loc11_)
                     {
                        ...
                        {
                           _roomEngine.connection.send(new PickupObjectMessageComposer(param3,param4));
                           _roomEngine.connection.send(new PlaceObjectMessageComposer(param3,RoomObjectCategoryEnum.const_26,_loc12_,0,0,0));
                        }
                     }
                  }
               }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_263:
               _roomEngine.events.dispatchEvent(param1);
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_407:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_351:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_347:
               _loc7_ = "null";
         }
         if(_loc7_ == null)
         {
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_233:
               handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_380:
               handleRoomObjectMouseMove(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_422:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_1193,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            if(wasSelected)
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_436));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_399));
            }
         }
      }
      ...
      private function handleRoomActionEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_446:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_293);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_318);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      {
         var _loc3_:Map = var_684.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_684.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_684.add(param1,_loc4_);
         }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_436);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_399);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_63)
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_170:
               handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_720:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_57:
               ...
               break;
            case RoomObjectMoveEvent.const_477:
               handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_425:
            ...
            case RoomObjectFurnitureActionEvent.const_434:
            case RoomObjectFurnitureActionEvent.const_490:
            ...
            case RoomObjectRoomAdEvent.const_347:
               ...
               break;
            case RoomObjectRoomActionEvent.const_446:
            case RoomObjectRoomActionEvent.const_1049:
            case RoomObjectRoomActionEvent.const_462:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_413:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_871));
               break;
            case RoomObjectFurnitureActionEvent.const_434:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1254));
               break;
            case RoomObjectFurnitureActionEvent.const_490:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_980));
         }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:String, param4:IRoomGeometry) : void
      {
         ...
         var _loc6_:int = _roomEngine.getRoomObjectCategory(_loc5_);
         if(_loc6_ != RoomObjectCategoryEnum.const_63)
         {
            _loc6_ = 0;
         }
