package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_643:Number = 64;
      
      public static const const_933:Number = 32;
      ...
      private var var_1692:Number = 1.0;
      
      private var var_2512:Number = 500.0;
      
      private var var_1691:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_92 = new Vector3d();
         var_1169 = new Vector3d();
         var_1690 = 1;
         var_1691 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1692 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(var_257.x != _loc2_ || var_257.y != _loc3_ || var_257.z != _loc4_)
         {
            ++var_81;
         }
      ...
      {
         if(var_467 != param1 * var_1692)
         {
            var_467 = param1 * var_1692;
            ++var_81;
         }
      }
      ...
      {
         if(var_465 != param1 * var_1690)
         {
            var_465 = param1 * var_1690;
            ++var_81;
         }
      }
      ...
      {
         if(var_468 != param1 * var_1691)
         {
            var_468 = param1 * var_1691;
            ++var_81;
         }
      }
      ...
      {
         return new Vector3d(var_257.x,var_257.y,var_257.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1169.assign(_loc22_);
         }
         else
         {
            var_1169.assign(_loc17_);
         }
         ++var_81;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_468;
         _loc2_.z *= var_467;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1169);
         if(_loc3_ < var_2511 || _loc3_ > var_2512)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_468;
            _loc2_.z *= var_467;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1169);
         }
      ...
      {
         return new Vector3d(0 * var_465,0 * var_468,0 * var_467);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_465,0 * var_468,0 * var_467);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_92;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_465,param2.y * var_468,param2.z * var_467);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_465,param3.y * var_468,param3.z * var_467);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_465,param4.y * var_468,param4.z * var_467);
