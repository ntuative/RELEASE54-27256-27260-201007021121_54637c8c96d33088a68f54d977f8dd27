package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_269:IRoomObject;
      
      protected var var_157:int = -1;
      
      private var _updateID:int = 0;
      
      private var var_193:Array;
      
      protected var var_306:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(var_193 != null)
         {
            while(false)
            {
               _loc1_ = var_193[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_193.length > param1)
         {
            _loc2_ = var_193["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < var_193.length)
         {
