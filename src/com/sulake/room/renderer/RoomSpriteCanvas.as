package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1462:int = 50;
      ...
      private var var_1776:Number = -1.0E7;
      
      private var var_1778:Number = -1.0E7;
      
      private var var_2501:int = 0;
      
      private var var_492:RoomObjectCache;
      
      private var var_712:int;
      
      private var var_266:Sprite;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_54 = new Sprite();
         var_54.name = "canvas";
         var_54.mouseEnabled = false;
         _master.addChild(var_54);
         var_54.mouseEnabled = true;
         var_54.doubleClickEnabled = true;
         var_54.addEventListener(MouseEvent.CLICK,clickHandler);
         var_54.addEventListener(MouseEvent.DOUBLE_CLICK,clickHandler);
         _geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         var_230 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_308 = new Map();
         var_492 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_230.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_230.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_492.removeObjectCache(param1);
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_266 != null)
         {
            var_266.graphics.clear();
         }
         else
         {
            var_266 = new Sprite();
            var_266.name = "mask";
            _master.addChild(var_266);
         }
         var_266.graphics.beginFill(0);
         var_266.graphics.drawRect(0,0,param1,param2);
         var_712 = param1;
         var_713 = param2;
         var_54.graphics.clear();
         var_54.graphics.beginFill(var_2501);
         var_54.graphics.drawRect(0,0,param1,param2);
         var_54.mask = var_266;
      }
      ...
      {
         var _loc11_:Number = param1 - var_712 / 2;
         var _loc12_:Number = param2 - var_713 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_712 != var_1779 || var_713 != var_1780)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_407.sortOn("z",0 | 0);
         if(_loc5_ < var_407.length)
         {
            var_407.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_407[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_493.length)
            {
               cleanSprite(var_493[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_493 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_308 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_308.getKey(_loc1_);
            _loc3_ = var_308.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1048 != null)
                  {
                     var_1048.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_735,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_230.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_230.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_54.numChildren)
         {
            return null;
         }
         return var_54.getChildAt(param1) as ExtendedSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1049.x = param1;
         var_1049.y = param2;
         if(var_855 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1512;
         }
         var_1512 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_855;
         return var_1512;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         while(_loc5_ >= param1)
         {
            _loc3_ = var_54.getChildAt(_loc5_);
            _loc6_ = null;
      ...
      {
         if(param1 < 0 || param1 >= var_407.length)
         {
            return null;
         }
         return var_407[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = var_54.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_494.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_494.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1776 || param2 != var_1778)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_494.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_494.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_493.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= var_54.numChildren)
         {
            var_54.addChild(_loc3_);
         }
         else
         {
            var_54.addChildAt(_loc3_,param2);
         }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(param1 >= var_54.numChildren)
         {
            createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = var_54.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_230.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_230.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_492.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_492.getObjectCache(param2);
         ...
         _loc13_ += int(var_712 / 2);
         _loc14_ += int(var_713 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_712 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_713))
                  {
