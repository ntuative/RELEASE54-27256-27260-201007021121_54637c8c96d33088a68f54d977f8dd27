package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_549:XML;
      
      protected var var_1022:LoaderContext;
      
      protected var var_32:Array;
      
      protected var var_591:Array;
      
      private var var_698:uint = 0;
      
      protected var var_482:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_32 = new Array();
         var_591 = new Array();
         var_1022 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_482 = new AssetLibrary("lib-" + var_698++);
         var_32.push(var_482);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_482.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_482.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_591.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_482.loadAssetFromFile(param1,param2,param3);
      }
      
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         return var_482.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_482.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_482.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            loaderContext = var_1022;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + var_698++);
         var_591.push(_loc3_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_591.length)
            {
               _loc3_ = var_591[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_591.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_482.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_482.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
