package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1121:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_646:uint = 0;
      
      public static const const_621:String = "AssetLibraryReady";
      
      public static const const_1417:String = "AssetLibraryUnloaded";
      
      public static const const_475:String = "AssetLibraryLoaded";
      
      public static const const_1423:String = "AssetLibraryLoadError";
       
      
      private var var_549:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_646;
         var_443 = new Dictionary(false);
         var_442 = new Dictionary(false);
         var_762 = new Dictionary(false);
         var_140 = new Dictionary(false);
         var_1121.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_443)
         {
            _loc4_ = AssetTypeDeclaration(var_443[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_140)
         {
            delete var_140[_loc1_];
         }
         ...
         var_323 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1417));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_549 = _loc2_.manifest.copy();
         var_378 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_548)
         {
            AssetLibrary.fetchLibraryContents(this,var_549,var_378);
         }
         var_323 = true;
         dispatchEvent(new Event(AssetLibrary.const_475));
         dispatchEvent(new Event(AssetLibrary.const_621));
         if(var_548)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_39,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1009,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1044,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_852,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1016,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_443.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_443[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1121.splice(var_1121.indexOf(this),1);
            --var_646;
            var_442 = null;
            var_762 = null;
            var_140 = null;
      ...
      {
         return param1 < var_377.length ? getAssetByName(var_377[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1423));
         var_17 = null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_140)
         {
            if(var_140[_loc2_] == param1)
            {
               return var_377.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_443)
         {
            _loc3_ = AssetTypeDeclaration(var_443[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_549.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_378[param1]);
      ...
      {
         var _loc2_:IAsset = var_140[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_39,e.status);
                     break;
                  }
                  if(true)
                  {
                     ++var_210;
                     var_377.push(struct.assetName);
                  }
                  var_140[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_39,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_140)
            {
               if(var_140[_loc2_] == param1)
               {
                  var_377.splice(var_377.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_443[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_378 != null ? false : false;
      }
   }
}
