package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1443:int = 10000;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_73 = new Socket();
         var_348 = new Timer(const_1443,1);
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_701));
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         var_348.stop();
         var_1212 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_701));
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_593.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_349)
         {
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_701));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_701));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = var_593.getMessages(var_264,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               {
                  eventsForClass = var_313.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  else
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = var_313.getMessageParser(parserClass);
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_701));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         ...
         var_1212 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_701));
         dispatchEvent(param1);
      }
