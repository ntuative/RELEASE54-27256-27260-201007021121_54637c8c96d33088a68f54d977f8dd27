package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1449:uint = 2;
      
      protected static const const_1452:uint = 1;
      
      public static const const_947:int = 5;
      
      protected static const name_2:uint = 7;
      
      protected static const const_1450:uint = 4;
      
      protected static const const_1451:uint = 3;
      ...
      protected var var_194:int;
      
      protected var _name:String;
      
      protected var var_378:Class;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_378 = this.getDefinition(_name) as Class;
         if(var_378 == null)
         {
         ...
         try
         {
            xmlClass = var_378.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_549 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_153 + " for file \"" + var_17.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
         ...
         if(var_479 == LibraryLoader.const_1451)
         {
            if(analyzeLibrary())
            {
               var_479 |= 0;
      ...
      {
         return !!var_585 ? uint(var_194 - var_838) : uint(getTimer() - var_838);
      }
