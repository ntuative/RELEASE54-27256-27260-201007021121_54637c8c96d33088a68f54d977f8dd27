package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1460:int = 4;
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         _loc2_ = var_687.indexOf(param1);
         if(_loc2_ > -1)
         {
            var_687.splice(_loc2_,1);
         }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(var_261.length < const_1460 && false)
            {
               _loc1_ = var_687.shift();
               var_261.push(_loc1_);
               _loc1_.resume();
            }
         }
