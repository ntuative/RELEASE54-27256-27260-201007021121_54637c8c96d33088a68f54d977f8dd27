package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_957:Boolean = false;
      
      protected var var_1029:uint = 500;
      
      protected var var_1021:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_855,var_11);
         }
         return var_19;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_1021,PropertyStruct.const_54,var_1021 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_957 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_1021 = _loc2_.value as Boolean;
               if(var_1021)
               {
