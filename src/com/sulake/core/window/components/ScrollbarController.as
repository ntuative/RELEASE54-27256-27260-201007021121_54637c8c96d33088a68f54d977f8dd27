package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1095:String = "increment";
      
      private static const const_515:String = "slider_bar";
      
      private static const const_1096:String = "decrement";
      
      private static const const_776:String = "slider_track";
      ...
      protected var var_837:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_173 = false;
         var_23 = param12;
         _horizontal = param2 == WindowType.const_464;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_515:
         ...
         if(param2.type == WindowNotifyEvent.const_487)
         {
            if(var_23 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(const_776) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_23 != null && true)
         {
            IWindow(var_23).removeEventListener(WindowEvent.const_42,onScrollableResized);
         }
         var_23 = param1;
         if(var_23 != null && true)
         {
            IWindow(var_23).addEventListener(WindowEvent.const_42,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(const_515) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_877 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_877 != null)
         {
            _loc1_ = findParentByName(var_877) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_877) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_48)
         {
            ...
            else if(param2.name == const_1096)
            {
               if(var_23)
               {
                  var_612 = true;
            ...
            else if(param2.name == const_776)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_515).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_944)
         {
