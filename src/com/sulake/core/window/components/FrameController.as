package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_825:String = "margin_top";
      
      private static const const_1164:String = "_SCALER";
      
      private static const const_823:String = "margin_right";
      
      private static const const_1166:String = "_HEADER";
      
      private static const const_1163:String = "_TITLE";
      
      private static const const_1165:String = "_CONTENT";
      
      private static const const_822:String = "margin_left";
      
      private static const const_824:String = "margin_bottom";
      ...
      private var var_1451:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_822,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_825,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_823,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_824,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1069,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_264);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_240);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_238);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1451 == null)
         {
            var_1451 = findChildByTag(const_1166) as IHeaderWindow;
            if(!var_1451)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1163) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1164) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_247,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1165) as IWindowContainer;
            if(!var_22)
            {
