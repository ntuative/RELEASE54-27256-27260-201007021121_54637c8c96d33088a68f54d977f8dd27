package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_360:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_134 = context.create(name + "::submenu","",WindowType.const_391,var_83,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_48)
         {
            if(param2 is IDropMenuItemWindow)
            {
               selection = getMenuItemIndex(param2 as IDropMenuItemWindow);
         ...
         else if(param1.type == WindowEvent.const_967)
         {
            if(param2 == var_134)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_408,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_326,var_83,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
      ...
      protected function openMenuView() : void
      {
         if(!var_629)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_528,getSubMenu(),subMenuEventProc);
                  var_629 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_397,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_527 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_348,this,null));
         }
      }
      ...
      {
         return getChildByName(DropMenuController.const_360) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_629 = false;
            getTitleText().text = var_527 < var_528.length && var_527 > -1 ? "null" : caption;
         }
      }
   }
}
