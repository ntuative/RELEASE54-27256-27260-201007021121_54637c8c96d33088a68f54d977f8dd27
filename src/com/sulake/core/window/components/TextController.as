package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_224:Boolean;
      
      protected var var_71:TextMargins;
      
      protected var var_584:String = "none";
      
      protected var var_689:Number;
      
      protected var var_394:Number;
      
      protected var _field:TextField;
      
      protected var var_835:Boolean = false;
      ...
      {
         return new Rectangle(var_689 * maxScrollH,var_394 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_835)
         {
            context.removeLocalizationListener(var_342,this);
         }
         if(var_71 != null)
         {
            var_71.dispose();
      ...
      {
         var_689 = param1;
         _field.scrollH = var_689 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_342 = param1;
         if(var_342.charAt(0) == "$" && var_342.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_342.slice(2,var_342.indexOf("}")),this);
            var_835 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_224)
         {
            if(param2.type == WindowNotifyEvent.const_169)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_935,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_478,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_478,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_61,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_681,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_681,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_54,true));
         _loc1_.push(new PropertyStruct("margin_left",var_71.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_71.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_71.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_71.bottom,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("auto_size",var_584,PropertyStruct.STRING,var_584 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_681,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_689 = var_689;
         _loc1_.var_394 = var_394;
         _loc1_.var_71 = var_71.clone(_loc1_.setTextMargins);
         _loc1_.var_584 = var_584;
         _loc1_.var_835 = var_835;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_584 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_584 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_584 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_584 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
