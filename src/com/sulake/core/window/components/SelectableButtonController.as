package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
      ...
      public function get selector() : ISelectorWindow
      {
         ...
         if(var_12)
         {
            _loc1_ = var_12 as WindowController;
            while(_loc1_)
            {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_350)
         {
            if(var_12)
            {
               if(!(var_12 is ISelectorWindow))
               {
                  _loc3_ = var_12.parent as WindowController;
                  while(_loc3_)
                  {
                     if(_loc3_ is ISelectorWindow)
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_234,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_397,this,null);
         update(this,_loc1_);
         ...
         _loc1_.type = WindowNotifyEvent.const_348;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_630,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
