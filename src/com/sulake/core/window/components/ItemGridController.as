package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function ItemGridController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _horizontal = param2 != WindowType.const_503;
         var_587 = true;
         if(!_horizontal)
         {
      ...
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_336,WindowStyle.const_315,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            if(_loc6_)
            {
               ...
               {
                  if(_loc4_.rectangle.right + param1.width <= var_11.width)
                  {
                     return addColumnForItem(param1);
                  }
               }
      ...
      protected function rebuildGridStructure() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:int = 0;
         var _loc1_:int = numGridItems;
         var _loc2_:Array = new Array();
         var _loc3_:int = numColumns;
         while(_loc1_ > 0)
         {
            _loc6_ = 0;
            while(_loc6_ < _loc3_)
