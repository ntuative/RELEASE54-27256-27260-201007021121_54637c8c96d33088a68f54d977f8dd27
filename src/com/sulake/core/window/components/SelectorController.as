package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      protected var var_2415:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_234)
         {
         ...
         if(param1 != null)
         {
            if(param1 != _selected)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_348,this,_selected));
               }
            }
         }
      }
