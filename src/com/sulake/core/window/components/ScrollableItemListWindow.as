package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_919:IItemListWindow;
      
      private var var_375:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_66))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_375)
         {
            var_375 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_375)
            {
               var_375.addEventListener(WindowEvent.const_262,scrollBarEventProc);
               var_375.addEventListener(WindowEvent.const_230,scrollBarEventProc);
            }
         }
         return var_375;
      }
      ...
      override public function dispose() : void
      {
         if(var_375)
         {
            var_375.removeEventListener(WindowEvent.const_262,scrollBarEventProc);
            var_375.removeEventListener(WindowEvent.const_230,scrollBarEventProc);
            var_375 = null;
         }
         if(var_919)
         {
      ...
      {
         if(param1.type == WindowEvent.const_262)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_230)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_919)
         {
            var_919 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_919;
      }
