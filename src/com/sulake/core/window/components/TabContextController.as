package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1117:String = "_CONTENT";
      
      private static const const_1116:String = "_SELECTOR";
       
      
      private var var_1450:Boolean = false;
      
      protected var var_1023:ITabSelectorWindow;
      
      private var var_957:Boolean = false;
      
      protected var var_1726:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1726 == null)
         {
            var_1726 = findChildByTag(const_1117) as IWindowContainer;
         }
         return var_1726;
      }
      ...
      {
         return var_1023.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1023 == null)
         {
            var_1023 = findChildByTag(const_1116) as ITabSelectorWindow;
            if(var_1023 != null)
            {
               var_1023.procedure = selectorEventProc;
            }
         }
         return var_1023;
      }
      ...
      {
         return !!var_957 ? selector.iterator : null;
      }
