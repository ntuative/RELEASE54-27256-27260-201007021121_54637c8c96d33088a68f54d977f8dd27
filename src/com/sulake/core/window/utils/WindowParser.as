package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1644:String = "_INCLUDE";
      
      public static const const_981:String = "_EXCLUDE";
      
      public static const const_1564:String = "_TEMP";
      
      private static const const_1182:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1181:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1207:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1207,var_1208);
      ...
      {
         param1 = param1.replace(const_1181,"");
         return param1.replace(const_1182,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1207)
            {
               delete var_1207[_loc1_];
            }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "true";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "true";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "true";
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_177)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_981) == -1)
                  {
