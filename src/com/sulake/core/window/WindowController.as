package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1459:String = "_IGNORE_INHERITED_STYLE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      private static var var_1473:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      private static var var_1712:Point = new Point();
      
      protected static const const_1069:String = "_COLORIZE";
      ...
      protected var var_697:Function;
      
      protected var _children:Array;
      
      protected var var_694:Boolean = false;
      
      private var var_2382:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_438 = _loc13_.blend;
            var_590 = _loc13_.treshold;
            if(var_695 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_589 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_270)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_303)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_175)
               {
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_975,this,null);
         update(this,_loc1_);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_845;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_695 = param1;
         var_589 = !!var_695 ? uint(var_589 | var_1490) : uint(var_589 & 16777215);
      ...
      {
         var_590 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2382 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_905:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_350:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_900:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1397:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_397:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_348:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_630:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_587:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_234:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_83 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_460,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_725,var_11);
            var_19.visible = var_351;
         }
         return var_19;
      }
      ...
      {
         var_438 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1043);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1187 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_305,this,param1));
         return param1;
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_156 != null)
         {
            param3.x = var_156.x;
            param3.y = var_156.y;
            param3.width = var_156.width;
            param3.height = var_156.height;
         }
         if(param4 != null && var_155 != null)
         {
            param4.x = var_155.x;
            param4.y = var_155.y;
            param4.width = var_155.width;
            param4.height = var_155.height;
         }
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_590);
      }
      
      public function set color(param1:uint) : void
      {
         var_1490 = param1 & 4278190080;
         var_589 = !!var_695 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_988;
                  if(testParamFlag(WindowParam.const_337))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_224))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_264))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_224))
                  {
                     _context.getWindowServices().getMouseDraggingService().end(this);
                  }
                  if(testParamFlag(WindowParam.const_264))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_169:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_463,this,null));
                     if(testParamFlag(WindowParam.const_177,WindowParam.const_146))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_12 != null)
                     {
                        _loc9_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_483))
                        {
                           var_12.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_405:
                  _context.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_390);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_878,this,null));
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_286,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_350:
                  if(param1 == this)
                  {
                     ...
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_234,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_430:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_999);
                  break;
               case WindowNotifyEvent.const_460:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1459) == -1)
                     {
                        _loc8_.style = var_83;
                     }
                  }
               ...
               case WindowNotifyEvent.const_424:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_390);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_234:
                  ...
                  break;
               case WindowNotifyEvent.const_463:
                  var_12.getRegionProperties(null,var_341);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_305:
      ...
      {
         return var_697 != null ? var_697 : (var_12 != null ? var_12.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_590);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_350;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_544,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_637;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1187 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_37 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_430,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_406)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_435)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_375)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_431)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_847,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_546,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_405,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_169,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1392,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,true);
         _loc1_.type = WindowNotifyEvent.const_1272;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_173 && var_590 > 0)
         {
            if(!testParamFlag(WindowParam.const_29))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1712,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1712,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1278,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,false);
         _loc1_.type = WindowNotifyEvent.const_1314;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_12 != param1)
         {
            ...
            if(var_12 != null)
            {
               var_341 = var_12.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_487,this,var_12));
            }
            else
            {
               var_341.x = 0;
               ...
               var_341.width = 0;
               var_341.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_934,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_424,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,_param,_context,var_11,null,var_697,properties,var_696.concat(),_id) as WindowController;
         _loc2_.var_590 = var_590;
         _loc2_.var_173 = var_173;
         _loc2_.var_694 = var_694;
         _loc2_.var_341 = var_341.clone();
         ...
         _loc2_.var_155 = !!var_155 ? var_155.clone() : null;
         _loc2_.var_78 = !!var_78 ? var_78.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_589 = var_589;
         _loc2_.var_1490 = var_1490;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_373;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            if(var_155 == null)
            {
               var_155 = new Rectangle();
            }
            var_155.x = param3.x;
            var_155.y = param3.y;
            var_155.width = param3.width;
            var_155.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            var_156.x = param2.x;
            var_156.y = param2.y;
            var_156.width = param2.width;
            var_156.height = param2.height;
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_945;
         update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_838;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_37 == WindowState.const_417)
         {
            return true;
         }
         var_37 = WindowState.const_417;
