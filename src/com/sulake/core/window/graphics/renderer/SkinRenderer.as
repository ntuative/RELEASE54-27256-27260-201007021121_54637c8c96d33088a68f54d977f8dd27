package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_484:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_344)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_344[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_343[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_484[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_343[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_344[param1] = _loc3_;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_484[_loc1_]).dispose();
            delete var_484[_loc1_];
         }
         var_484 = null;
         _layoutsByState = null;
         for(_loc1_ in var_343)
         {
            ISkinTemplate(var_343[_loc1_]).dispose();
            delete var_343[_loc1_];
         }
         var_343 = null;
         var_344 = null;
      }
