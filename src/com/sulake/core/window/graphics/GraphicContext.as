package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_957:uint = 256;
      
      protected static var var_698:uint = 0;
      
      protected static var var_400:uint = 0;
      
      public static const const_855:uint = 2;
      
      public static const const_1669:uint = 128;
      
      public static const const_1519:uint = 64;
      
      public static const const_554:uint = 4;
      
      public static const const_1246:uint = 0;
      
      public static const const_1375:uint = 16;
      
      public static const const_725:uint = 1;
      ...
      protected var var_691:Boolean;
      
      protected var var_1725:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1203:
               ...
               break;
            case GraphicContext.const_1375:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_554:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_957:
               break;
            case GraphicContext.const_1246:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_691)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_400 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_171 = new Sprite();
            var_171.name = this.name + " - Child Container";
            var_171.mouseEnabled = false;
            addChild(var_171);
         }
         return var_171;
      }
         ...
         if(var_691)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_400 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1725,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1725,16777215);
                  }
                  var_400 += bitmap.width * bitmap.height * 4;
               }
