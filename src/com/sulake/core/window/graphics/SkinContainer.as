package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_399:Array;
      
      private static const const_777:uint = 8;
      ...
      private var var_1933:Dictionary;
      
      private var var_513:Dictionary;
      
      private var var_1296:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1933 = new Dictionary();
         TypeCodeTable.fillTables(var_1559,var_1933);
         var_1296 = new Dictionary();
         var_1934 = new Dictionary();
         StateCodeTable.fillTables(var_1296,var_1934);
         ...
         {
            var_399 = new Array();
            var_399.push(WindowState.const_59);
            var_399.push(WindowState.const_66);
            var_399.push(WindowState.const_93);
            var_399.push(WindowState.WINDOW_STATE_SELECTED);
            var_399.push(WindowState.const_79);
            var_399.push(WindowState.const_75);
            var_399.push(WindowState.const_96);
            var_399.push(WindowState.const_83);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1296)
         {
            _loc3_.push(var_1296[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1559[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_737[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_736[param1] = new Array(SkinContainer.const_777);
         }
         var_736[param1][param2] = param3;
         if(true)
         {
            var_737[param1] = new Array(SkinContainer.const_777);
         }
         var_737[param1][param2] = param4;
      }
