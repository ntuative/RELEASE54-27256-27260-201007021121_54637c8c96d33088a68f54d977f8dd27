package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected var var_261:Array;
      
      protected var var_396:Array;
      
      protected var var_694:Boolean = false;
      
      protected var var_305:Array;
      
      protected var var_225:DisplayObjectContainer;
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1226);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_261.length)
         {
            if(var_261[_loc3_].url == param1.url)
            {
               return var_261[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
         var _loc4_:LibraryLoader = new LibraryLoader(param2,var_694);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc8_:uint = var_196.mapStructsByImplementor(this,_loc7_);
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_305.length)
         {
            _loc10_ = var_305[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_396 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_396.pop()).dispose();
               }
               var_396 = null;
            }
            if(var_261 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_396[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1406);
      }
      
      public final function detachComponent(param1:Component) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = var_196.getIndexByImplementor(param1);
         while(_loc3_ > -1)
         {
            _loc2_ = var_196.remove(_loc3_);
            _loc3_ = var_196.getIndexByImplementor(param1);
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_305.length)
         {
            if(var_305[_loc4_] == param1)
            {
               var_305.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_648);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_648);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_648);
                  }
               }
      ...
      {
         var _loc3_:InterfaceStruct = var_196.getStructByInterface(param1);
         if(_loc3_ != null)
         {
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            var_196.insert(new InterfaceStruct(_loc5_,param1));
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
