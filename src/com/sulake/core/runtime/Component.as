package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_942:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1589:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_196.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1030 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1030);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1209 & const_942)
         {
            if(_loc3_ == 0)
            {
               if(var_196.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_196.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_406 + "]";
      }
