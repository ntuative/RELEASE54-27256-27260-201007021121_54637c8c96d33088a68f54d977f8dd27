package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_18:String = "client.init.swf.loaded";
      
      public static const const_2:String = "fileLoadingBar";
      
      public static const const_20:String = "error_desc";
      ...
      public static const const_14:String = "crash_time";
      ...
      public static const const_22:String = "client.init.core.fail";
      
      public static const const_19:String = "error_cat";
      
      public static const const_11:String = "textField";
      ...
      public static const const_16:String = "debug";
      
      public static const const_13:String = "avg_update";
      
      public static const ERROR_VARIABLE_DATA:String = "error_data";
      
      public static const const_15:String = "flash_version";
       
      
      private var _disposed:Boolean = false;
      
      private var var_9:int;
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_14] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_17] = _loc7_;
            _loc6_[const_15] = Capabilities.version;
            _loc6_[const_13] = 0;
            _loc6_[const_20] = param1;
            _loc6_[const_19] = String(param2);
            if(param3 != null)
            {
               _loc6_[ERROR_VARIABLE_DATA] = String(param3.getStackTrace());
            }
            _loc6_[const_16] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_8,error);
         }
      }
      ...
      private function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc5_:TextField = param1.getChildByName(const_11) as TextField;
         if(_loc5_)
         {
      ...
      {
         trackLoginStep(const_9);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_8,const_8,null);
      }
